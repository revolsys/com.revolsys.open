...
public class Nts250000RectangularMapGridTest extends
  ...
  protected void doTestNts1000000ByName(
    ...
    for (char letter = 'A'; letter <= 'P'; letter++) {
      final double lon = parentLon - GridUtil.getLetter16Col(letter)
        * TILE_WIDTH;
      final double lat = parentLat + GridUtil.getLetter16Row(letter)
        * TILE_HEIGHT;
