...
public class Bcgs1000RectangularMapGrid extends Bcgs2000RectangularMapGrid {
  ...
  public Bcgs1000RectangularMapGrid() {
    super(BcgsConstants.WIDTH_1000, BcgsConstants.HEIGHT_1000);
  }

  protected Bcgs1000RectangularMapGrid(
    final double width,
    final double height) {
    super(width, height);
  }
  ...
  public double getLatitude(
    ...
    if (matcher.matches()) {
      ...
      throw new IllegalArgumentException(mapTileName
        + " does not start with a valid BCGS 1:1,000 tile name");
    }
  }
  ...
  protected double getLatitude(
    ...
    final String number2000,
    final String number1000) {
