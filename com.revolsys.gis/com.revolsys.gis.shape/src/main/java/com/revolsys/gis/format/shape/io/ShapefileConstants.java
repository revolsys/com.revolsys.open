...
public class ShapefileConstants {
  ...
  static {
    ...
    DATA_TYPE_MAP.put(POLYLINE_M_SHAPE, DataTypes.MULTI_LINESTRING);
    DATA_TYPE_MAP.put(POLYLINE_Z_SHAPE, DataTypes.MULTI_LINESTRING);
    DATA_TYPE_MAP.put(POLYLINE_SHAPE, DataTypes.MULTI_LINESTRING);
