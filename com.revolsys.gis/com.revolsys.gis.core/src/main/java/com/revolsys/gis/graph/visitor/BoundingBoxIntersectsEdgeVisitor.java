...
public class BoundingBoxIntersectsEdgeVisitor<T> extends NestedVisitor<Edge<T>> {
  public static <T> List<Edge<T>> getEdges(
    ...
    final CoordinateSystem coordinateSystem = GeometryFactory.getFactory(line)
      .getCoordinateSystem();
    final BoundingBox boundingBox = new BoundingBox(coordinateSystem,
  ...
  public BoundingBoxIntersectsEdgeVisitor(
