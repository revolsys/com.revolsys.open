...
public class LasZipLayeredChunkedWriter extends LasPointCloudWriter {
  ...
  public LasZipLayeredChunkedWriter(final LasPointCloud pointCloud,
  ...
  public void done() {
    if (this.chunkPointCount == 0) {
      ...
      this.out.putInt(this.chunkPointCount);
