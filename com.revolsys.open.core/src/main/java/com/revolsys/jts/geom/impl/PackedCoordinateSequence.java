    ...
    implements CoordinateSequence
{
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequence#getDimension()
   */
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequence#getCoordinate(int)
   */
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequence#toCoordinateArray()
   */
...
// testing - never cache
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequence#getX(int)
   */
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequence#getY(int)
   */
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequence#getOrdinate(int, int)
   */
  ...
  public static class Double extends PackedCoordinateSequence {
    ...
    /**
     * @see com.revolsys.jts.geom.CoordinateSequence#size()
     */
    public int size() {
    ...
    /**
     * @see com.revolsys.jts.geom.PackedCoordinateSequence#setOrdinate(int,
     *      int, double)
     */
