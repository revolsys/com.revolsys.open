    ...
    CoordinateSequenceFactory
{
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequenceFactory#create(com.revolsys.jts.geom.Coordinate[])
   */
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequenceFactory#create(com.revolsys.jts.geom.CoordinateSequence)
   */
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequenceFactory#create(double[],
   *      int)
   */
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequenceFactory#create(float[],
   *      int)
   */
  ...
  /**
   * @see com.revolsys.jts.geom.CoordinateSequenceFactory#create(int, int)
   */
