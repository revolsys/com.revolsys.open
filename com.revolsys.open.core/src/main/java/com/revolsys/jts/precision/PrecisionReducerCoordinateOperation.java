...
public class PrecisionReducerCoordinateOperation extends
  ...
  public PrecisionReducerCoordinateOperation(final PrecisionModel targetPM,
    final boolean removeCollapsed) {
    this.targetPM = targetPM;
    this.removeCollapsed = removeCollapsed;
  }

  @Override
  public Coordinates[] edit(final Coordinates[] coordinates, final Geometry geom) {
