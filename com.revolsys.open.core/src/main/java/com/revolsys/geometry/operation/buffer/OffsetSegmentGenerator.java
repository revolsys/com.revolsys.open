...
class OffsetSegmentGenerator {
  ...
  private void addBevelJoin(final LineSegment offset0, final LineSegment offset1) {
    this.segList.addPt(offset0.getP1());
    this.segList.addPt(offset1.getP0());
  }
  ...
  private void addFillet(final Point p, final double startAngle, final double endAngle,
    ...
    final int nSegs = (int)(totalAngle / this.filletAngleQuantum + 0.5);
  ...
  public void addLastSegment() {
    this.segList.addPt(this.offset1.getP1());
  }
  ...
  public void addSegments(final LineString points, final boolean isForward) {
    this.segList.addPts(points, isForward);
  }
