...
public interface NormalizedParameterNames {
  ...
  ParameterName CENTRAL_MERIDIAN = new MultiParameterName(ParameterNames.CENTRAL_MERIDIAN,
    ParameterNames.LONGITUDE_OF_CENTRE, ParameterNames.LONGITUDE_OF_ORIGIN,
  ...
  ParameterName LATITUDE_OF_CENTRE = new MultiParameterName(ParameterNames.LATITUDE_OF_CENTRE,
