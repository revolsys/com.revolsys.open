...
public class StaticMethodPredicate<T> implements Predicate<T> {
  ...
  public StaticMethodPredicate() {
  }

  public StaticMethodPredicate(final Class<?> methodClass, final String methodName,
    final Object... args) {
