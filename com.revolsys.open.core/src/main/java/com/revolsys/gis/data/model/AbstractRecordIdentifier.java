...
public abstract class AbstractRecordIdentifier implements RecordIdentifier {

  public static void setIdentifier(final Map<String, Object> record,
    final List<String> idAttributeNames, final RecordIdentifier identifier) {
    if (identifier == null) {
  ...
  @Override
  public int compareTo(final RecordIdentifier other) {
    if (other == this) {
      return 0;
    } else if (other == null) {
      return -1;
  ...
  public boolean equals(final Object other) {
    if (other == this) {
      return true;
    } else if (other instanceof RecordIdentifier) {
      final RecordIdentifier recordIdentifier = (RecordIdentifier)other;
  ...
  @Override
  public void setIdentifier(final DataObject record) {
