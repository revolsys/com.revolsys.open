 ...
 * short-circuiting the evaluation. <coordinates> This class handles polygonal
 * geometries with any number of shells and holes. The orientation of the shell
 * and hole rings is unimportant. In order to compute a correct location for a
 * given polygonal geometry, it is essential that <b>all</b> segments are
 * counted which
 * <ul>
 * <li>touch the ray
