...
public class MonotoneChainEdge {
  ...
  public double getMinX(int chainIndex) {
    double x1 = pts.getX(startIndex[chainIndex]);
    double x2 = pts.getX(startIndex[chainIndex + 1]);
    return x1 < x2 ? x1 : x2;
  }
  ...
  public void computeIntersectsForChain(int chainIndex0, MonotoneChainEdge mce,
  ...
  private void computeIntersectsForChain(int start0, int end0,
    ...
    Coordinates  p10 = mce.pts.get(start1);
    Coordinates  p11 = mce.pts.get(end1);
