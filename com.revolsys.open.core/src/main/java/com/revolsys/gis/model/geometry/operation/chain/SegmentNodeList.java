...
public class SegmentNodeList {
   ...
   */
  public SegmentNode add(Coordinates intPt, int segmentIndex) {
  ...
  private void findCollapsesFromExistingVertices(List collapsedVertexIndexes) {
    for (int i = 0; i < edge.size() - 2; i++) {
      Coordinates p0 = edge.getCoordinate(i);
  ...
  private boolean findCollapseIndex(SegmentNode ei0, SegmentNode ei1,
  ...
  private void checkSplitEdgesCorrectness(List splitEdges) {
    CoordinatesList edgePts = edge.getCoordinates();
    ...
    Coordinates pt0 = split0.getCoordinate(0);
    ...
    CoordinatesList splitnPts = splitn.getCoordinates();
    Coordinates ptn = splitnPts.get(splitnPts.size() - 1);
  ...
  SegmentString createSplitEdge(SegmentNode ei0, SegmentNode ei1) {
    ...
    CoordinatesList pts = new DoubleCoordinatesList(npts, 2);
    int ipt = 0;
