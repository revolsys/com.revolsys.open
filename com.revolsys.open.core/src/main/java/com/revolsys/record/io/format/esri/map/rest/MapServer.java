...
import com.revolsys.record.io.format.esri.map.rest.map.LayerDescription;
import com.revolsys.record.io.format.esri.map.rest.map.LevelOfDetail;
import com.revolsys.record.io.format.esri.map.rest.map.TableDescription;
import com.revolsys.record.io.format.esri.map.rest.map.TileInfo;
import com.revolsys.record.io.format.esri.map.rest.map.TimeInfo;
