...
public class ArrayRecord extends BaseRecord {
    ...
    public ArrayRecord(final RecordDefinition recordDefinition, final Iterable<? extends Object> values) {
    ...
    public ArrayRecord(final RecordDefinition recordDefinition, final Map<String, ? extends Object> values) {
        super(recordDefinition);
        initDefaultValues(recordDefinition);
        initValues(values);
