...
public class GeometryInputDialog extends JDialog {
  ...
  public GeometryInputDialog(final Frame frame, final String title,
    final boolean modal) {
  ...
  void btnLoad_actionPerformed(final ActionEvent e) {
    parseError = false;
  ...
  Geometry getGeometry(final int index) {
    return geom[index];
  }
  ...
  void jbInit() throws Exception {
    ...
    jPanel1.add(jLabel1, new GridBagConstraints(0, 0, 1, 1, 0.1, 0.0,
      GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 5),
      0, 0));
    jPanel1.add(jLabel2, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
      GridBagConstraints.CENTER, GridBagConstraints.NONE,
      new Insets(0, 5, 0, 5), 0, 0));
    jPanel1.add(lblError, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
      GridBagConstraints.CENTER, GridBagConstraints.BOTH,
      new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(txtError, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.2,
      GridBagConstraints.CENTER, GridBagConstraints.BOTH,
      new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(jScrollPane1, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.3,
      GridBagConstraints.CENTER, GridBagConstraints.BOTH,
      new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(jScrollPane2, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.3,
      GridBagConstraints.CENTER, GridBagConstraints.BOTH,
      new Insets(0, 0, 0, 0), 0, 0));
  ...
  Geometry parseGeometry(final JTextComponent txt, final Color clr) {
    try {
      final WKTReader rdr = new WKTReader(JTSTestBuilder.model()
        .getGeometryFactory());
      final Geometry g = rdr.read(txt.getText());
      txtError.setText("");
      return g;
    } catch (final Exception ex) {
