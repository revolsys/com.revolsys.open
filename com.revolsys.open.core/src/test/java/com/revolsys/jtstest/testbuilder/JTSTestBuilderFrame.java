...
import com.revolsys.jtstest.clean.CleanDuplicatePoints;
import com.revolsys.jtstest.clean.LineStringExtracter;
import com.revolsys.jtstest.testbuilder.controller.JTSTestBuilderController;
import com.revolsys.jtstest.testbuilder.controller.ResultController;
import com.revolsys.jtstest.testbuilder.model.GeometryEvent;
import com.revolsys.jtstest.testbuilder.model.HtmlWriter;
...
import com.revolsys.jtstest.testbuilder.ui.ImageUtil;
import com.revolsys.jtstest.testbuilder.ui.SwingUtil;
import com.revolsys.jtstest.testbuilder.ui.dnd.FileDrop;
import com.revolsys.jtstest.testbuilder.ui.tools.DeleteVertexTool;
import com.revolsys.jtstest.testbuilder.ui.tools.EditVertexTool;
import com.revolsys.jtstest.testbuilder.ui.tools.ExtractComponentTool;
import com.revolsys.jtstest.testbuilder.ui.tools.InfoTool;
import com.revolsys.jtstest.testbuilder.ui.tools.LineStringTool;
import com.revolsys.jtstest.testbuilder.ui.tools.PanTool;
import com.revolsys.jtstest.testbuilder.ui.tools.PointTool;
import com.revolsys.jtstest.testbuilder.ui.tools.RectangleTool;
import com.revolsys.jtstest.testbuilder.ui.tools.StreamPolygonTool;
import com.revolsys.jtstest.testbuilder.ui.tools.ZoomToClickTool;
...
public class JTSTestBuilderFrame extends JFrame {
  ...
  private final ResultController resultController = new ResultController(this);

  private final JTSTestBuilderMenuBar tbMenuBar = new JTSTestBuilderMenuBar(
    this);

  private final JTSTestBuilderToolBar tbToolBar = new JTSTestBuilderToolBar(
    this);
  ...
  private final ImageIcon appIcon = new ImageIcon(this.getClass().getResource(
    "app-icon.gif"));
  ...
  private final TextViewDialog textViewDlg = new TextViewDialog(this, "", true);

  private final TestCaseTextDialog testCaseTextDlg = new TestCaseTextDialog(
    this, "", true);

  private final GeometryInspectorDialog geomInspectorDlg = new GeometryInspectorDialog(
    this);

  /*
   * private LoadTestCasesDialog loadTestCasesDlg = new
   * LoadTestCasesDialog(this, "Load Test Cases", true);
   */
  ...
  public JTSTestBuilderFrame() {
    try {
      ...
      jbInit();
      // #setRollover was introduced in Java 1.4 and is not present in 1.3.1.
      // [Jon Aquino]
      // jToolBar1.setRollover(true);
      // initList(tcList);
      // loadEditList(testpp);
      // testCasePanel.setModel(tbModel);
      testCasePanel.spatialFunctionPanel.addSpatialFunctionPanelListener(new SpatialFunctionPanelListener() {
        @Override
        public void functionExecuted(final SpatialFunctionPanelEvent e) {
          resultController.spatialFunctionPanel_functionExecuted(e);
        }
      });
      testCasePanel.scalarFunctionPanel.addSpatialFunctionPanelListener(new SpatialFunctionPanelListener() {
        @Override
        public void functionExecuted(final SpatialFunctionPanelEvent e) {
          resultController.scalarFunctionPanel_functionExecuted(e);
        }
      });
      testCasePanel.editCtlPanel.btnSetPrecisionModel.addActionListener(new java.awt.event.ActionListener() {
        @Override
        public void actionPerformed(final ActionEvent e) {
          precisionModelMenuItem_actionPerformed(e);
        }
      });
      testCasePanel.editCtlPanel.cbMagnifyTopo.addActionListener(new java.awt.event.ActionListener() {
        @Override
        public void actionPerformed(final ActionEvent e) {
      ...
      testCasePanel.getGeometryEditPanel().setCurrentTool(
        RectangleTool.getInstance());
  ...
  void actionDeleteVertexButton() {
    testCasePanel.getGeometryEditPanel().setCurrentTool(
      DeleteVertexTool.getInstance());
  }

  void actionExtractComponentButton() {
    testCasePanel.getGeometryEditPanel().setCurrentTool(
      ExtractComponentTool.getInstance());
  }

  void actionInspectGeometry() {
    final int geomIndex = tbModel.getGeometryEditModel().getGeomIndex();
    geomInspectorDlg.setGeometry(geomIndex == 0 ? AppStrings.GEOM_LABEL_A
      : AppStrings.GEOM_LABEL_B,
      tbModel.getCurrentTestCaseEdit().getGeometry(geomIndex));
    geomInspectorDlg.setVisible(true);
  }

  void btnDeleteCase_actionPerformed(final ActionEvent e) {
    tbModel.deleteCase();
    updateTestCaseView();
    testListPanel.populateList();
  }

  void btnEditVertex_actionPerformed(final ActionEvent e) {
    testCasePanel.getGeometryEditPanel().setCurrentTool(
      EditVertexTool.getInstance());
  }

  void btnExchangeGeoms_actionPerformed(final ActionEvent e) {
  ...
  public void copyResultToTest() {
    final Object currResult = tbModel.getResult();
    if (!(currResult instanceof Geometry)) {
      return;
    }
    tbModel.addCase(new Geometry[] {
      (Geometry)currResult, null
  ...
  void deleteAllTestCasesMenuItem_actionPerformed(final ActionEvent e) {
    tbModel.initTestCaseList();
    updateTestCaseView();
    testListPanel.populateList();
  }

  public void displayInfo(final Coordinates modelPt) {
  ...
  public void displayInfo(final String s, final boolean showTab) {
    logPanel.addInfo(s);
    if (showTab) {
      showInfoTab();
    }
  ...
  void drawLineStringButton_actionPerformed(final ActionEvent e) {
    testCasePanel.getGeometryEditPanel().setCurrentTool(
      LineStringTool.getInstance());
  }

  void drawPointButton_actionPerformed(final ActionEvent e) {
    testCasePanel.getGeometryEditPanel()
      .setCurrentTool(PointTool.getInstance());
  }

  void drawPolygonButton_actionPerformed(final ActionEvent e) {
    testCasePanel.getGeometryEditPanel().setCurrentTool(
      StreamPolygonTool.getInstance());
  }

  void drawRectangleButton_actionPerformed(final ActionEvent e) {
    testCasePanel.getGeometryEditPanel().setCurrentTool(
      RectangleTool.getInstance());
  }
  ...
  public String getRunXml() {
    return XMLTestWriter.getRunXml(tbModel.getTestCaseList(),
      tbModel.getGeometryFactory());
  }
  ...
  void infoButton_actionPerformed(final ActionEvent e) {
  ...
  /*
   * void menuLoadTestCases_actionPerformed(ActionEvent e) { try {
   * loadTestCasesDlg.show(); TestCaseList tcl = loadTestCasesDlg.getList();
   * loadTestCaseList(tcl, new PrecisionModel()); refreshNavBar(); } catch
   * (Exception x) { reportException(this, x); } } void
   * loadTestCaseList(TestCaseList tcl, PrecisionModel precisionModel) throws
   * Exception { tbModel.setPrecisionModel(precisionModel); if (tcl != null) {
   * loadEditList(tcl); } testListPanel.populateList(); }
   */

  private void initFileDrop(final Component comp) {
  ...
  private void jbInit() throws Exception {
    ...
    final Dimension frameSize = textViewDlg.getSize();
    ...
    textViewDlg.setLocation((screenSize.width - frameSize.width) / 2,
      (screenSize.height - frameSize.height) / 2);
    /*
     * loadTestCasesDlg.setLocation((screenSize.width - frameSize.width) / 2,
     * (screenSize.height - frameSize.height) / 2);
     */
    ...
    /*
     * testCasePanel.editPanel.addGeometryListener( new
     * com.revolsys.jtstest.testbuilder.model.GeometryListener() { public void
     * geometryChanged(GeometryEvent e) { editPanel_geometryChanged(e); } });
     */
  ...
  public void jMenuHelpAbout_actionPerformed(final ActionEvent e) {
    final JTSTestBuilder_AboutBox dlg = new JTSTestBuilder_AboutBox(this);
    final java.awt.Dimension dlgSize = dlg.getPreferredSize();
    final java.awt.Dimension frmSize = getSize();
    final java.awt.Point loc = getLocation();
  ...
  void menuChangeToLines_actionPerformed(final ActionEvent e) {
    final LineStringExtracter lse = new LineStringExtracter();
    final Geometry cleanGeom = lse.extract(tbModel.getCurrentTestCaseEdit()
      .getGeometry(0));
    tbModel.getCurrentTestCaseEdit().setGeometry(0, cleanGeom);
    updateGeometry();
  }

  void menuExchangeGeom_actionPerformed(final ActionEvent e) {
    tbModel.getCurrentTestCaseEdit().exchange();
    testCasePanel.setTestCase(tbModel.getCurrentTestCaseEdit());
  }

  void menuLoadXmlTestFile_actionPerformed(final ActionEvent e) {
    try {
  ...
  void menuLoadXmlTestFolder_actionPerformed(final ActionEvent e) {
    try {
  ...
  void menuRemoveDuplicatePoints_actionPerformed(final ActionEvent e) {
    final CleanDuplicatePoints clean = new CleanDuplicatePoints();
    final Geometry cleanGeom = clean.clean(tbModel.getCurrentTestCaseEdit()
      .getGeometry(0));
    tbModel.getCurrentTestCaseEdit().setGeometry(0, cleanGeom);
    updateGeometry();
  }

  void menuSaveAsHtml_actionPerformed(final ActionEvent e) {
    try {
      ...
      if (JFileChooser.APPROVE_OPTION == directoryChooser.showSaveDialog(this)) {
        ...
        // try {
        // busyDialog.execute("Saving .html and .gif files", new
        // BusyDialog.Executable() {
        // public void execute() throws Exception {
        writer.write(directory, tbModel.getTestCaseList(),
          tbModel.getGeometryFactory().getPrecisionModel());
        // }
        // });
        // }
        // catch (Exception e2) {
  ...
  void menuSaveAsJava_actionPerformed(final ActionEvent e) {
    try {
      ...
      if (JFileChooser.APPROVE_OPTION == fileChooser.showSaveDialog(this)) {
        ...
        final int extensionIndex = className.lastIndexOf(".");
        if (extensionIndex > 0) {
  ...
  void menuSaveAsPNG_actionPerformed(final ActionEvent e) {
    initFileChoosers();
    try {
      final String fullFileName = SwingUtil.chooseFilenameWithConfirm(this,
        pngFileChooser);
      if (fullFileName == null) {
        return;
      }
      ImageUtil.writeImage(testCasePanel.getGeometryEditPanel(), fullFileName,
  ...
  void menuSaveAsXml_actionPerformed(final ActionEvent e) {
    try {
      fileChooser.removeChoosableFileFilter(SwingUtil.JAVA_FILE_FILTER);
      fileChooser.addChoosableFileFilter(SwingUtil.XML_FILE_FILTER);
      ...
      if (JFileChooser.APPROVE_OPTION == fileChooser.showSaveDialog(this)) {
        ...
        FileUtil.setContents(
          ...
          XMLTestWriter.getRunXml(tbModel.getTestCaseList(),
            tbModel.getGeometryFactory()));
      }
    } catch (final Exception x) {
      SwingUtil.reportException(this, x);
  ...
  void menuSaveScreenToClipboard_actionPerformed(final ActionEvent e) {
    try {
  ...
  void moveToPrevCase(final boolean isZoom) {
    tbModel.prevCase();
    updateTestCaseView();
    if (isZoom) {
      JTSTestBuilderController.zoomToInput();
  ...
  void oneToOneButton_actionPerformed(final ActionEvent e) {
  ...
  void panButton_actionPerformed(final ActionEvent e) {
  ...
  void precisionModelMenuItem_actionPerformed(final ActionEvent e) {
    try {
      final PrecisionModelDialog precisionModelDialog = new PrecisionModelDialog(
        this, "Edit Precision Model", true);
      GuiUtil.center(precisionModelDialog, this);
      precisionModelDialog.setPrecisionModel(tbModel.getGeometryFactory()
        .getPrecisionModel());
  ...
  private void reportProblemsParsingXmlTestFile(final List parsingProblems) {
    if (parsingProblems.isEmpty()) {
      return;
    }
    for (final Iterator i = parsingProblems.iterator(); i.hasNext();) {
      final String problem = (String)i.next();
      System.out.println(problem);
    }
    JOptionPane.showMessageDialog(
      this,
      StringUtil.wrap(parsingProblems.size()
        + " problems occurred parsing the XML test file."
        + " The first problem was: " + parsingProblems.get(0), 80), "Error",
  ...
  public void setModel(final TestBuilderModel model) {
    ...
    model.getGeometryEditModel().addGeometryListener(
      new com.revolsys.jtstest.testbuilder.model.GeometryListener() {
        @Override
        public void geometryChanged(final GeometryEvent e) {
  ...
  public void setShowingGrid(final boolean showGrid) {
    testCasePanel.editPanel.setGridEnabled(showGrid);
    JTSTestBuilderController.geometryViewChanged();
  }

  public void setShowingOrientations(final boolean showingOrientations) {
    TestBuilderModel.setShowingOrientation(showingOrientations);
    JTSTestBuilderController.geometryViewChanged();
  }

  public void setShowingStructure(final boolean showStructure) {
    TestBuilderModel.setShowingStructure(showStructure);
    JTSTestBuilderController.geometryViewChanged();
  }

  public void setShowingVertices(final boolean showingVertices) {
    TestBuilderModel.setShowingVertices(showingVertices);
    JTSTestBuilderController.geometryViewChanged();
  }

  public void setShowVertexIndices(final boolean showVertexIndices) {
  ...
  void showVertexIndicesMenuItem_actionPerformed(final ActionEvent e) {
  ...
  private void updatePrecisionModelDescription() {
    testCasePanel.setPrecisionModelDescription(tbModel.getGeometryFactory()
      .toString());
  }

  private void updateStatsPanelIfVisible() {
    final int index = inputTabbedPane.getSelectedIndex();
    if (index < 0) {
      return;
    }
  ...
  public void updateTestCaseView() {
    testCasePanel.setTestCase(tbModel.getCurrentTestCaseEdit());
    getTestCasePanel().setCurrentTestCaseIndex(
      tbModel.getCurrentTestIndex() + 1);
  ...
  private void updateWktPanel() {
    final Geometry g0 = tbModel.getGeometryEditModel().getGeometry(0);
    wktPanel.setText(g0, 0);
    final Geometry g1 = tbModel.getGeometryEditModel().getGeometry(1);
    wktPanel.setText(g1, 1);
  }

  void zoomInButton_actionPerformed(final ActionEvent e) {
    testCasePanel.getGeometryEditPanel().setCurrentTool(zoomInTool);
  }

  void zoomToFullExtentButton_actionPerformed(final ActionEvent e) {
    testCasePanel.getGeometryEditPanel().zoomToFullExtent();
  }

  void zoomToInputA_actionPerformed(final ActionEvent e) {
    testCasePanel.getGeometryEditPanel().zoomToGeometry(0);
  }

  void zoomToInputB_actionPerformed(final ActionEvent e) {
    testCasePanel.getGeometryEditPanel().zoomToGeometry(1);
  }

  void zoomToInputButton_actionPerformed(final ActionEvent e) {
    testCasePanel.getGeometryEditPanel().zoomToInput();
  }

  void zoomToResult_actionPerformed(final ActionEvent e) {
