...
public class MinimumBoundingCircleTest extends TestCase {
  ...
  private void doMinimumBoundingCircleTest(final String wkt,
    final String expectedWKT, final Coordinate expectedCentre,
