...
public class GeometryImplTest extends TestCase {
  ...
  public void testEqualsExactForLinearRings() throws Exception {
    final LinearRing x = this.geometryFactory.createLinearRing(new Coordinate[] {
      new Coordinate(0, 0), new Coordinate(100, 0), new Coordinate(100, 100),
      new Coordinate(0, 0)
    });
    final LinearRing somethingExactlyEqual = this.geometryFactory.createLinearRing(new Coordinate[] {
      new Coordinate(0, 0), new Coordinate(100, 0), new Coordinate(100, 100),
      new Coordinate(0, 0)
    });
    final LinearRing somethingNotEqualButSameClass = this.geometryFactory.createLinearRing(new Coordinate[] {
  ...
  public void testEqualsExactForLineStrings() throws Exception {
    final LineString x = this.geometryFactory.createLineString(new Coordinate[] {
      new Coordinate(0, 0), new Coordinate(100, 0), new Coordinate(100, 100)
    });
    final LineString somethingExactlyEqual = this.geometryFactory.createLineString(new Coordinate[] {
      new Coordinate(0, 0), new Coordinate(100, 0), new Coordinate(100, 100)
    });
    final LineString somethingNotEqualButSameClass = this.geometryFactory.createLineString(new Coordinate[] {
      new Coordinate(0, 0), new Coordinate(100, 0), new Coordinate(100, 555)
    });
    final LineString sameClassButEmpty = this.geometryFactory.createLineString((Coordinate[])null);
    final LineString anotherSameClassButEmpty = this.geometryFactory.createLineString((Coordinate[])null);
    final CollectionFactory collectionFactory = new CollectionFactory() {
      @Override
      public Geometry createCollection(final Geometry[] geometries) {
        return GeometryImplTest.this.geometryFactory.createMultiLineString(GeometryFactory.toLineStringArray(Arrays.asList(geometries)));
  ...
  public void testEqualsExactForPoints() throws Exception {
    final Point x = this.geometryFactory.createPoint(new Coordinate(100, 100));
    final Point somethingExactlyEqual = this.geometryFactory.createPoint(new Coordinate(
      100, 100));
    final Point somethingNotEqualButSameClass = this.geometryFactory.createPoint(new Coordinate(
      999, 100));
    final Point sameClassButEmpty = this.geometryFactory.createPoint((Coordinate)null);
    final Point anotherSameClassButEmpty = this.geometryFactory.createPoint((Coordinate)null);
    final CollectionFactory collectionFactory = new CollectionFactory() {
      @Override
      public Geometry createCollection(final Geometry[] geometries) {
