...
public class EnvelopeTest extends TestCase {
  ...
  public void testAsGeometry() throws Exception {
    ...
    final Geometry g = this.geometryFactory.createPoint(new Coordinate(5, 6))
      .getEnvelope();
    ...
    assertEquals(new Coordinate(10, 40),
      poly.getExteriorRing().getCoordinateN(1));
    assertEquals(new Coordinate(30, 40),
      poly.getExteriorRing().getCoordinateN(2));
    assertEquals(new Coordinate(30, 10),
