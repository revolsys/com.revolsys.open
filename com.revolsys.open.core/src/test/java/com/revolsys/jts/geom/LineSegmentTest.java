...
public class LineSegmentTest extends TestCase {
  ...
  public static boolean equalsTolerance(final Coordinate p0,
    final Coordinate p1, final double tolerance) {
  ...
  void checkOffset(final double x0, final double y0, final double x1,
    ...
    final Coordinate p = seg.pointAlongOffset(segFrac, offset);

    assertTrue(equalsTolerance(new Coordinate(expectedX, expectedY), p,
      0.000001));
  }
  ...
  void checkOrientationIndex(final LineSegment seg, final double s0x,
    ...
    final LineSegment seg2 = new LineSegment(s0x, s0y, s1x, s1y);
  ...
  void checkOrientationIndex(final LineSegment seg, final double px,
    ...
    final Coordinate p = new Coordinate(px, py);
  ...
  public void testOrientationIndexCoordinate() {
    final LineSegment seg = new LineSegment(0, 0, 10, 10);
  ...
  public void testOrientationIndexSegment() {
    final LineSegment seg = new LineSegment(100, 100, 110, 110);
