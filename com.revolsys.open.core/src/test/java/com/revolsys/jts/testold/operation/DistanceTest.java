...
public class DistanceTest extends TestCase {
  ...
  public void testClosestPoints2() throws Exception {
    doNearestPointsTest("POLYGON ((200 180, 60 140, 60 260, 200 180))",
      "MULTIPOINT ((140 280), (140 320))", 57.05597791103589, new PointDouble(
  ...
  public void testClosestPoints3() throws Exception {
    doNearestPointsTest(
      ...
      "POINT (10 10)", 127.27922061357856, new PointDouble((double)100, 100,
  ...
  public void testClosestPoints4() throws Exception {
    doNearestPointsTest("LINESTRING (100 100, 200 200)",
      "LINESTRING (100 200, 200 100)", 0.0, new PointDouble(150.0, 150.0),
      new PointDouble(150.0, 150.0));
  }

  public void testClosestPoints5() throws Exception {
    doNearestPointsTest("LINESTRING (100 100, 200 200)",
      "LINESTRING (150 121, 200 0)", 20.506096654409877, new PointDouble(135.5,
        135.5, Point.NULL_ORDINATE), new PointDouble((double)150, 121,
        Point.NULL_ORDINATE));
  }
  ...
  public void testClosestPoints7() throws Exception {
    doNearestPointsTest(
      ...
      new PointDouble((double)120, 215, Point.NULL_ORDINATE), new PointDouble(
        (double)120, 215, Point.NULL_ORDINATE));
  }

  public void testDisjointCollinearSegments() throws Exception {
    final Geometry g1 = reader.read("LINESTRING (0.0 0.0, 9.9 1.4)");
    final Geometry g2 = reader.read("LINESTRING (11.88 1.68, 21.78 3.08)");
    assertEquals(2.23606, g1.distance(g2), 0.0001);
  }

  public void testEmpty() throws Exception {
    final Geometry g1 = reader.read("POINT (0 0)");
    final Geometry g2 = reader.read("POLYGON EMPTY");
    assertEquals(0.0, g1.distance(g2), 0.0);
  }

  public void testEverything() throws Exception {
    final Geometry g1 = reader.read("POLYGON ((40 320, 200 380, 320 80, 40 40, 40 320),  (180 280, 80 280, 100 100, 220 140, 180 280))");
    ...
    final LineString l1 = (LineString)reader.read("LINESTRING(10 10, 20 20, 30 40)");
    final LineString l2 = (LineString)reader.read("LINESTRING(10 10, 20 20, 30 40)");
