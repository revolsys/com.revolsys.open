package com.revolsys.jts.testold.operation.distance3d;
...
public class Distance3DOpTest extends TestCase {
  ...
  public void testLinePolygonHoleFlat() {
    // line crossing hole
    checkDistance("LINESTRING (150 150 10, 150 150 -10)", this.polyHoleFlat, 30);
  ...
  public void testPointPoint() {
    checkDistance("POINT (0 0 0 )", "POINT (0 0 1 )", 1);
  ...
  public void testPointPolygonHoleFlat() {
    ...
    checkDistance("POINT (130 130 10)", this.polyHoleFlat, 14.14213562373095);
    // point below poly hole
    checkDistance("POINT (130 130 -10)", this.polyHoleFlat, 14.14213562373095);
    // point above poly
    checkDistance("POINT (110 110 100)", this.polyHoleFlat, 100);
  }
  ...
  public void testPointSegFlat() {
    checkDistance("LINESTRING (10 10 0, 10 20 0 )", "POINT (20 15 0 )", 10);
  }
