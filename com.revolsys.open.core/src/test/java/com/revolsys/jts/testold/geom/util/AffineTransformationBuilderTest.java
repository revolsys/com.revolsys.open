...
public class AffineTransformationBuilderTest extends TestCase {
  private final Coordinates ctl0 = new Coordinate(-10, -10, Coordinates.NULL_ORDINATE);

  private final Coordinates ctl1 = new Coordinate(10, 20, Coordinates.NULL_ORDINATE);

  private final Coordinates ctl2 = new Coordinate(10, -20, Coordinates.NULL_ORDINATE);
  ...
  void run(final double p0x, final double p0y, final double pp0x,
    ...
    final Coordinates pp0 = new Coordinate(pp0x, pp0y, Coordinates.NULL_ORDINATE);
  ...
  void run(final double p0x, final double p0y, final double p1x,
    ...
    final double pp1y) {
    final Coordinates p0 = new Coordinate(p0x, p0y, Coordinates.NULL_ORDINATE);
    final AbstractCoordinates p1 = new Coordinate(p1x, p1y, Coordinates.NULL_ORDINATE);

    final Coordinates pp0 = new Coordinate(pp0x, pp0y, Coordinates.NULL_ORDINATE);
    final AbstractCoordinates pp1 = new Coordinate(pp1x, pp1y, Coordinates.NULL_ORDINATE);
  ...
  void run(final double p0x, final double p0y, final double p1x,
    ...
    final Coordinates pp0 = new Coordinate(pp0x, pp0y, Coordinates.NULL_ORDINATE);
    final Coordinates pp1 = new Coordinate(pp1x, pp1y, Coordinates.NULL_ORDINATE);
    final Coordinates pp2 = new Coordinate(pp2x, pp2y, Coordinates.NULL_ORDINATE);
