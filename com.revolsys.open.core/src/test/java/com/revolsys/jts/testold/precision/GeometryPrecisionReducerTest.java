...
public class GeometryPrecisionReducerTest extends TestCase {
  ...
  public void testPolgonWithCollapsedLine() throws Exception {
    final Geometry g = this.reader.read("POLYGON ((10 10, 100 100, 200 10.1, 300 10, 10 10))");
    final Geometry g2 = this.reader.read("POLYGON ((10 10, 100 100, 200 10, 10 10))");
    final Geometry gReduce = this.reducer.reduce(g);
    assertEqualsExactAndHasSameFactory(gReduce, g2);
  }
  ...
  public void testPolgonWithCollapsedLinePointwise() throws Exception {
    final Geometry g = this.reader.read("POLYGON ((10 10, 100 100, 200 10.1, 300 10, 10 10))");
    final Geometry g2 = this.reader.read("POLYGON ((10 10, 100 100, 200 10,   300 10, 10 10))");
    final Geometry gReduce = GeometryPrecisionReducer.reducePointwise(g,
      this.pmFixed1);
    assertEqualsExactAndHasSameFactory(gReduce, g2);
  }

  public void testPolgonWithCollapsedPoint() throws Exception {
    final Geometry g = this.reader.read("POLYGON ((10 10, 100 100, 200 10.1, 300 100, 400 10, 10 10))");
    final Geometry g2 = this.reader.read("MULTIPOLYGON (((10 10, 100 100, 200 10, 10 10)), ((200 10, 300 100, 400 10, 200 10)))");
    final Geometry gReduce = this.reducer.reduce(g);
    assertEqualsExactAndHasSameFactory(gReduce, g2);
  }
  ...
  public void testPolgonWithCollapsedPointPointwise() throws Exception {
    final Geometry g = this.reader.read("POLYGON ((10 10, 100 100, 200 10.1, 300 100, 400 10, 10 10))");
    final Geometry g2 = this.reader.read("POLYGON ((10 10, 100 100, 200 10,   300 100, 400 10, 10 10))");
    final Geometry gReduce = GeometryPrecisionReducer.reducePointwise(g,
      this.pmFixed1);
    assertEqualsExactAndHasSameFactory(gReduce, g2);
  }
