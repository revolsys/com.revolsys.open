...
public class OrientationIndexFailureTest extends TestCase {
  ...
  public void testBadCCW() throws Exception {
    ...
    final Coordinates[] pts = {
      new Coordinate(1.4540766091864998, -7.989685402102996, Coordinates.NULL_ORDINATE),
      new Coordinate(23.131039116367354, -7.004368924503866, Coordinates.NULL_ORDINATE),
      new Coordinate(1.4540766091865, -7.989685402102996, Coordinates.NULL_ORDINATE),
    };
  ...
  public void testBadCCW2() throws Exception {
    // this case fails because subtraction of small from large loses precision
    final Coordinates[] pts = {
      new Coordinate(219.3649559090992, 140.84159161824724, Coordinates.NULL_ORDINATE),
      new Coordinate(168.9018919682399, -5.713787599646864, Coordinates.NULL_ORDINATE),
      new Coordinate(186.80814046338352, 46.28973405831556, Coordinates.NULL_ORDINATE),
    };
    checkOrientation(pts);
  }
  ...
  public void testBadCCW3() throws Exception {
    // this case fails because subtraction of small from large loses precision
    final Coordinates[] pts = {
      new Coordinate(279.56857838488514, -186.3790522565901, Coordinates.NULL_ORDINATE),
      new Coordinate(-20.43142161511487, 13.620947743409914, Coordinates.NULL_ORDINATE),
  ...
  public void testBadCCW4() throws Exception {
    ...
    final Coordinates[] pts = {
      new Coordinate(-26.2, 188.7, Coordinates.NULL_ORDINATE), new Coordinate(37.0, 290.7, Coordinates.NULL_ORDINATE),
  ...
  public void testBadCCW5() throws Exception {
    ...
    final Coordinates[] pts = {
      new Coordinate(-5.9, 163.1, Coordinates.NULL_ORDINATE), new Coordinate(76.1, 250.7, Coordinates.NULL_ORDINATE),
  ...
  public void testBadCCW6() throws Exception {
    ...
    final Coordinates[] pts = {
      new Coordinate(-140.8859438214298, 140.88594382142983, Coordinates.NULL_ORDINATE),
      new Coordinate(-57.309236848216706, 57.30923684821671, Coordinates.NULL_ORDINATE),
      new Coordinate(-190.9188309203678, 190.91883092036784, Coordinates.NULL_ORDINATE)
    };
    checkOrientation(pts);
  }
  ...
  public void testBadCCW7() throws Exception {
    ...
    final Coordinates[] pts = {
      new Coordinate(-0.9575, 0.4511, Coordinates.NULL_ORDINATE), new Coordinate(-0.9295, 0.3291, Coordinates.NULL_ORDINATE),
  ...
  public void testBadCCW7_2() throws Exception {
    ...
    final Coordinates[] pts = {
      new Coordinate(-9575, 4511, Coordinates.NULL_ORDINATE), new Coordinate(-9295, 3291, Coordinates.NULL_ORDINATE),
      new Coordinate(-8945, 1766, Coordinates.NULL_ORDINATE)
    };
    checkDD(pts, true);
    checkShewchuk(pts, true);
