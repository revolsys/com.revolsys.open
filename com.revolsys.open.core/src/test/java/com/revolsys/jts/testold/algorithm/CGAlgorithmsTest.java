...
public class CGAlgorithmsTest extends TestCase {
  ...
  public void testDistanceLineLineDisjointCollinear() {
    assertEquals(1.999699, CGAlgorithms.distanceLineLine(new Coordinate((double)0.0, 0,
      Point.NULL_ORDINATE), new Coordinate((double)9.9, 1.4,
      Point.NULL_ORDINATE), new Coordinate((double)11.88, 1.68,
      Point.NULL_ORDINATE), new Coordinate((double)21.78, 3.08,
  ...
  public void testDistancePointLine() {
    assertEquals(0.5, CGAlgorithms.distancePointLine(new Coordinate((double)0.5, 0.5,
      ...
      Point.NULL_ORDINATE), new Coordinate((double)1.0, 0,
      Point.NULL_ORDINATE)), 0.000001);
  ...
  public void testDistancePointLinePerpendicular() {
    assertEquals(0.5, CGAlgorithms.distancePointLinePerpendicular(
      new Coordinate((double)0.5, 0.5, Point.NULL_ORDINATE), new Coordinate((double)0.0,
        0, Point.NULL_ORDINATE), new Coordinate((double)1.0, 0,
        Point.NULL_ORDINATE)), 0.000001);
    assertEquals(0.5, CGAlgorithms.distancePointLinePerpendicular(
      new Coordinate((double)3.5, 0.5, Point.NULL_ORDINATE), new Coordinate((double)0.0,
        0, Point.NULL_ORDINATE), new Coordinate((double)1.0, 0,
        Point.NULL_ORDINATE)), 0.000001);
    assertEquals(0.707106, CGAlgorithms.distancePointLinePerpendicular(
      new Coordinate((double)1.0, 0, Point.NULL_ORDINATE), new Coordinate((double)0.0, 0,
        Point.NULL_ORDINATE), new Coordinate((double)1.0, 1,
        Point.NULL_ORDINATE)), 0.000001);
  }
