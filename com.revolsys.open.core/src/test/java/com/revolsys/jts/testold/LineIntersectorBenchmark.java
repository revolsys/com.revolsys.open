...
public class LineIntersectorBenchmark implements Runnable {
  ...
  private void exerciseOnce(final LineIntersector lineIntersector) {
    Coordinate p1 = new Coordinate(10.0, 10, Coordinates.NULL_ORDINATE);
    Coordinate p2 = new Coordinate(20.0, 20, Coordinates.NULL_ORDINATE);
    Coordinate q1 = new Coordinate(20.0, 10, Coordinates.NULL_ORDINATE);
    Coordinate q2 = new Coordinate(10.0, 20, Coordinates.NULL_ORDINATE);
