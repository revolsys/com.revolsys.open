...
public class RobustLineIntersectionTest extends TestCase {
  public static boolean equals(final Point p0, final Point p1,
   ...
   */
  void checkIntersection(final Point[] pt,
    final int expectedIntersectionNum, final Point[] expectedIntPt,
    final double distanceTolerance) {
  ...
  void checkIntersection(final String wkt1, final String wkt2,
    final int expectedIntersectionNum, final Point[] intPt,
