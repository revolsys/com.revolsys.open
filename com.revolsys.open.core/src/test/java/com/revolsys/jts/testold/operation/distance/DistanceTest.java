 ...
 */
package com.revolsys.jts.testold.operation.distance;
...
public class DistanceTest extends TestCase {
  ...
  public void testClosestPoints1() throws Exception {
    doNearestPointsTest("POLYGON ((200 180, 60 140, 60 260, 200 180))",
      "POINT (140 280)", 57.05597791103589, new Coordinate(111.6923076923077,
        230.46153846153845, Coordinates.NULL_ORDINATE), new Coordinate(140, 280, Coordinates.NULL_ORDINATE));
  }

  public void testClosestPoints2() throws Exception {
    doNearestPointsTest("POLYGON ((200 180, 60 140, 60 260, 200 180))",
      "MULTIPOINT ((140 280), (140 320))", 57.05597791103589, new Coordinate(
        111.6923076923077, 230.46153846153845, Coordinates.NULL_ORDINATE), new Coordinate(140, 280, Coordinates.NULL_ORDINATE));
  }

  public void testClosestPoints3() throws Exception {
    doNearestPointsTest(
      "LINESTRING (100 100, 200 100, 200 200, 100 200, 100 100)",
      "POINT (10 10)", 127.27922061357856, new Coordinate(100, 100, Coordinates.NULL_ORDINATE),
      new Coordinate(10, 10, Coordinates.NULL_ORDINATE));
  }

  public void testClosestPoints4() throws Exception {
    doNearestPointsTest("LINESTRING (100 100, 200 200)",
      "LINESTRING (100 200, 200 100)", 0.0, new Coordinate(150, 150, Coordinates.NULL_ORDINATE),
      new Coordinate(150, 150, Coordinates.NULL_ORDINATE));
  }

  public void testClosestPoints5() throws Exception {
    doNearestPointsTest("LINESTRING (100 100, 200 200)",
      "LINESTRING (150 121, 200 0)", 20.506096654409877, new Coordinate(135.5,
        135.5, Coordinates.NULL_ORDINATE), new Coordinate(150, 121, Coordinates.NULL_ORDINATE));
  }
  ...
  public void testClosestPoints6() throws Exception {
    doNearestPointsTest(
      ...
      13.788860460124573,
      new Coordinate(139.4956500724988, 206.78661188980183, Coordinates.NULL_ORDINATE), new Coordinate(
  ...
  public void testClosestPoints7() throws Exception {
    doNearestPointsTest(
      ...
      new Coordinate(120, 215, Coordinates.NULL_ORDINATE), new Coordinate(120, 215, Coordinates.NULL_ORDINATE));
  }
