...
public class DouglasPeuckerSimplifierTest extends TestCase {
  ...
  public void testFlattishPolygon() throws Exception {
    new GeometryOperationValidator(DPSimplifierResult
      .getResult("POLYGON ((0 0, 50 0, 53 0, 55 0, 100 0, 70 1,  60 1, 50 1, 40 1, 0 0))", 10.0))
        .test();
  }
  ...
  public void testGeometryCollection() throws Exception {
    new GeometryOperationValidator(DPSimplifierResult.getResult("GEOMETRYCOLLECTION ("
      ...
      + "LINESTRING (80 200, 240 200, 240 60, 80 60, 80 200, 140 199, 120 120)" + ")", 10.0))
        .test();
  }
  ...
  public void testPolygonReduction() throws Exception {
    new GeometryOperationValidator(DPSimplifierResult.getResult(
      "POLYGON ((120 120, 121 121, 122 122, 220 120, 180 199, 160 200, 140 199, 120 120))", 10.0))
        .test();
  }

  public void testPolygonReductionWithSplit() throws Exception {
    new GeometryOperationValidator(DPSimplifierResult
      .getResult("POLYGON ((40 240, 160 241, 280 240, 280 160, 160 240, 40 140, 40 240))", 10.0))
        .test();
  }
  ...
  public void testTinyLineString() throws Exception {
    new GeometryOperationValidator(
      DPSimplifierResult.getResult("LINESTRING (0 5, 1 5, 2 5, 5 5)", 10.0)).test();
  }

  public void testTinySquare() throws Exception {
    new GeometryOperationValidator(
      DPSimplifierResult.getResult("POLYGON ((0 5, 5 5, 5 0, 0 0, 0 1, 0 5))", 10.0)).test();
  }
}
