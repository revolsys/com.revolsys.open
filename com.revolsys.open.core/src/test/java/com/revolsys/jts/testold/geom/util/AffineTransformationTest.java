package com.revolsys.jts.testold.geom.util;
...
public class AffineTransformationTest extends TestCase {
  ...
  void checkTransformation(final AffineTransformation trans0,
    final AffineTransformation trans1) {
  ...
  public void testCompose1() {
    final AffineTransformation t0 = AffineTransformation.translationInstance(
      10, 0);
    t0.rotate(Math.PI / 2);
    t0.translate(0, -10);

    final AffineTransformation t1 = AffineTransformation.translationInstance(0,
      0);
    t1.rotate(Math.PI / 2);
  ...
  public void testCompose2() {
    final AffineTransformation t0 = AffineTransformation.reflectionInstance(0,
      0, 1, 0);
    t0.reflect(0, 0, 0, -1);
  ...
  public void testCompose3() {
    ...
    final AffineTransformation t1 = AffineTransformation.reflectionInstance(0,
      0, -1, 1);
  ...
  public void testComposeRotation1() {
    final AffineTransformation t0 = AffineTransformation.rotationInstance(1,
      10, 10);

    final AffineTransformation t1 = AffineTransformation.translationInstance(
      -10, -10);
    t1.rotate(1);
    t1.translate(10, 10);
  ...
  public void testReflectXY2() throws IOException, ParseException {
    final AffineTransformation t = AffineTransformation.reflectionInstance(1,
      -1);
    checkTransformation(10, 0, t, 0, -10);
    checkTransformation(0, 10, t, -10, 0);
    checkTransformation(-10, -10, t, 10, 10);
  ...
  public void testReflectXYXY1() throws IOException, ParseException {
    final AffineTransformation t = AffineTransformation.reflectionInstance(0,
      5, 5, 0);
  ...
  public void testRotateAroundPoint1() throws IOException, ParseException {
    final AffineTransformation t = AffineTransformation.rotationInstance(
      Math.PI / 2, 1, 1);
  ...
  public void testTranslate1() throws IOException, ParseException {
    final AffineTransformation t = AffineTransformation.translationInstance(2,
      3);
  ...
  public void testTranslateRotate1() throws IOException, ParseException {
    final AffineTransformation t = AffineTransformation.translationInstance(3,
      3).rotate(Math.PI / 2);
