...
public class DistanceTest extends TestCase {
  ...
  private void doNearestPointsTest(final String wkt0, final String wkt1,
    final double distance, final Coordinate p0, final Coordinate p1)
  ...
  public void testClosestPoints6() throws Exception {
    doNearestPointsTest(
      ...
      13.788860460124573,
      new Coordinate(139.4956500724988, 206.78661188980183), new Coordinate(
        153, 204));
  }
  ...
  public void testClosestPoints7() throws Exception {
    doNearestPointsTest(
      ...
      new Coordinate(120, 215), new Coordinate(120, 215));
  }
