...
import com.revolsys.jts.generator.PolygonGenerator;
...
public class StaticMultiPolygonTest extends WritingTestCase {
   ...
   * @param arg
   */
  public StaticMultiPolygonTest(final String arg) {
    super(arg);
  }
   ...
   * @throws SAXException 
   */
  public void testSingleMultiPolygonHolesRoundTrip() throws SAXException,
    IOException, ParserConfigurationException {

    final PolygonGenerator pgc = new PolygonGenerator();
    ...
    final MultiPolygon pt = (MultiPolygon)pg.create();
   ...
   * @throws SAXException 
   */
  public void testSingleMultiPolygonNoHoleRoundTrip() throws SAXException,
    IOException, ParserConfigurationException {
    final PolygonGenerator pgc = new PolygonGenerator();
    pgc.setGeometryFactory(geometryFactory);
    pgc.setNumberPoints(10);
