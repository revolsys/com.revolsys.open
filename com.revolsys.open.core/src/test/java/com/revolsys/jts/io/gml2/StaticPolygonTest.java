...
public class StaticPolygonTest extends WritingTestCase {
   ...
   * @param arg
   */
  public StaticPolygonTest(final String arg) {
    super(arg);
  }
   ...
   * @throws SAXException 
   */
  public void testSinglePolygonHolesRoundTrip() throws SAXException,
    ...
    final Polygon pt = (Polygon)pg.create();
    checkRoundTrip(pt);
  }
   ...
   * @throws SAXException 
   */
  public void testSinglePolygonManyPointsHolesRoundTrip() throws SAXException,
    IOException, ParserConfigurationException {
    final PolygonGenerator pg = new PolygonGenerator();
    pg.setGeometryFactory(geometryFactory);
    pg.setBoundingBox(new Envelope(0, 10, 0, 10));
   ...
   * @throws SAXException 
   */
  public void testSinglePolygonManyPointsNoHoleRoundTrip() throws IOException,
   ...
   * @throws SAXException 
   */
  public void testSinglePolygonNoHoleRoundTrip() throws IOException,
    SAXException, ParserConfigurationException {
    final PolygonGenerator pg = new PolygonGenerator();
    pg.setGeometryFactory(geometryFactory);
    pg.setBoundingBox(new Envelope(0, 10, 0, 10));
