...
public abstract class AbstractIndexedLineTest extends TestCase {
  ...
  protected abstract Coordinate extractOffsetAt(Geometry input,
    Coordinate testPt, double offsetDistance);
  ...
  protected abstract boolean indexOfAfterCheck(Geometry input,
    Coordinate testPt, Coordinate afterPt);
  ...
  // throws Exception
  {
    ...
    final Coordinate testPt = testPoint.getCoordinate();
  ...
  // throws Exception
  {
    ...
    final Coordinate afterPt = afterPoint.getCoordinate();
  ...
  // throws Exception
  {
    ...
    final Coordinate testPt = testPoint.getCoordinate();
    final Coordinate expectedPt = expectedPoint.getCoordinate();
    final Coordinate offsetPt = extractOffsetAt(input, testPt, offsetDistance);
