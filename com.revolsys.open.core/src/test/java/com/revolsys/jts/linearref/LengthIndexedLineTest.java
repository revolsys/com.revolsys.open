...
public class LengthIndexedLineTest extends AbstractIndexedLineTest {
  ...
  @Override
  protected Coordinate extractOffsetAt(final Geometry linearGeom,
  ...
  protected boolean indexOfAfterCheck(final Geometry linearGeom,
    ...
    final Coordinate pt1 = indexedLine.extractPoint(loc1);
    final Coordinate pt2 = indexedLine.extractPoint(loc2);
  ...
  public void testComputeZ() {
    ...
    final LengthIndexedLine indexedLine = new LengthIndexedLine(linearGeom);
    final double projIndex = indexedLine.project(new Coordinate(5, 5));
    final Coordinate projPt = indexedLine.extractPoint(projIndex);
  ...
  public void testProjectExtractPoint() {
    ...
    final LengthIndexedLine indexedLine = new LengthIndexedLine(linearGeom);
    final double index = indexedLine.project(new Coordinate(1, 0));
  ...
  public void testProjectPointWithDuplicateCoords() {
    ...
    final LengthIndexedLine indexedLine = new LengthIndexedLine(linearGeom);
    final double projIndex = indexedLine.project(new Coordinate(10, 1));
