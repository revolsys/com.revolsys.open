...
public class LineSegmentTest {
  ...
  public void assertIntersection3d(final Point line1Start,
    ...
    final Geometry expectedIntersection) {
  ...
  public void linearIntersection() {
    ...
    assertIntersection3d(this.c_0_0_0, this.c_100_0_10, this.c_70_0,
      this.c_50_0, GEOMETRY_FACTORY_3D.lineString(this.c_50_0_5, this.c_70_0_7));

    // Middle Precision Model
    assertIntersection3d(this.c_0_0_0, point(100, 0.001, 10), point(50, 0.001),
      point(70, 0.001),
  ...
  public void pointIntersections() {
    ...
    assertIntersection3d(this.c_0_0_0, this.c_100_100_10, this.c_0_100_1,
      this.c_100_0_10, GEOMETRY_FACTORY_3D.point(50, 50, 5));

    assertIntersection3d(this.c_0_0_N, this.c_100_100_10, this.c_0_100_1,
      this.c_100_0_10, GEOMETRY_FACTORY_3D.point(50, 50, 5.5));
    ...
    // Touch approximate
    assertIntersection3d(this.c_0_0_0, point(100, 0.001, 10),
      point(50, 0.001, 5), this.c_100_100_10, point(50, 0.001, 5));
  }
}
