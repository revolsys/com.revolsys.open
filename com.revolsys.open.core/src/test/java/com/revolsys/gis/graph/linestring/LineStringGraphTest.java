...
public class LineStringGraphTest {
  ...
  public void testIntersectionFalseEndEnd() {
    ...
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(844400 1343000,844300 1343000,844200 1343000)");
  ...
  public void testIntersectionFalseEndStart() {
    final LineString line1 = geometryFactory.createGeometry("LINESTRING(844000 1343000,844100 1343000,844200 1343000)");
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(844200 1343000,844300 1343000,844400 1343000)");
  ...
  public void testIntersectionFalseStartEnd() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(844000 1343000,844100 1343000,844200 1343000)");
  ...
  public void testIntersectionFalseStartStart() {
    final LineString line1 = geometryFactory.createGeometry("LINESTRING(844000 1343000,844100 1343000,844200 1343000)");
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(844000 1343000,843900 1343000,843800 1343000)");
  ...
  public void testIntersectionTrueEndMiddle() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(800000 1000000,800000 1000010,800000 1000020)");
  ...
  public void testIntersectionTrueMiddleEnd() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(800020 1000010,800010 1000010,800000 1000010)");
  ...
  public void testIntersectionTrueMiddleMiddle() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(800000 1000000,800010 1000010,800020 1000000)");
  ...
  public void testIntersectionTrueMiddleStart() {
    final LineString line1 = geometryFactory.createGeometry("LINESTRING(800000 1000000,800000 1000010,800000 1000020)");
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(800000 1000010,800010 1000010,800020 1000010)");
  ...
  public void testIntersectionTrueStartMiddle() {
    final LineString line1 = geometryFactory.createGeometry("LINESTRING(800000 1000010,800010 1000010,800020 1000010)");
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(800000 1000000,800000 1000010,800000 1000020)");
  ...
  public void testIntersectionFalseStartLoop() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(800000 1000010,800000 1000000)");
  ...
  public void testIntersectionFalseStartLoop1() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(1189556.287 388686.558,1189555.995 388693.54,1189555.182 388694.284)");
  ...
  public void testIntersectionFalseLoopEndLoop() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(1190737.214 390156.946,1190735.656 390156.923,1190734.175 390153.953,1190737.214 390156.946)");
  ...
  public void testIntersectionFalseStartEndEndStart() {
    ...
    final LineStringGraph graph = new LineStringGraph(line1);
    final LineString line2 = geometryFactory.createGeometry("LINESTRING(800010 1000010,800000 1000010,800000 1000000)");
