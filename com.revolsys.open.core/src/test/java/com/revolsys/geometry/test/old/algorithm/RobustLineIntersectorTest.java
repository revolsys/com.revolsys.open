...
public class RobustLineIntersectorTest extends TestCase {
  ...
  public void testEndpointIntersection() {
    this.i.computeIntersectionPoints(new PointDouble((double)100, 100), new PointDouble((double)10, 100), new PointDouble((double)100, 10), new PointDouble((double)100, 100));
    assertTrue(this.i.hasIntersection());
    assertEquals(1, this.i.getIntersectionCount());
  }

  public void testEndpointIntersection2() {
    this.i.computeIntersectionPoints(new PointDouble((double)190, 50), new PointDouble((double)120, 100), new PointDouble((double)120, 100), new PointDouble((double)50, 150));
    assertTrue(this.i.hasIntersection());
    assertEquals(1, this.i.getIntersectionCount());
    assertEquals(new PointDouble((double)120, 100),
  ...
  public void testIsCCW() {
    assertEquals(1,
      CGAlgorithmsDD.orientationIndex(
        new PointDouble((double)-123456789, -40),
        new PointDouble((double)0, 0),
        new PointDouble(381039468754763d, 123456789)));
  }

  public void testIsCCW2() {
    assertEquals(0,
      CGAlgorithmsDD.orientationIndex(new PointDouble((double)10, 10),
        new PointDouble((double)20, 20),
        new PointDouble((double)0, 0)));
  }

  public void testIsProper1() {
    this.i.computeIntersectionPoints(new PointDouble((double)30, 10), new PointDouble((double)30, 30), new PointDouble((double)10, 10), new PointDouble((double)90, 11));
    assertTrue(this.i.hasIntersection());
    assertEquals(1, this.i.getIntersectionCount());
  ...
  public void testIsProper2() {
    this.i.computeIntersectionPoints(new PointDouble((double)10, 30), new PointDouble((double)10, 0), new PointDouble((double)11, 90), new PointDouble((double)10, 10));
    assertTrue(this.i.hasIntersection());
    assertEquals(1, this.i.getIntersectionCount());
    assertTrue(!this.i.isProper());
  }
  ...
  public void testOverlap() {
    this.i.computeIntersectionPoints(new PointDouble((double)180, 200), new PointDouble((double)160, 180), new PointDouble((double)220, 240), new PointDouble((double)140, 160));
    assertTrue(this.i.hasIntersection());
