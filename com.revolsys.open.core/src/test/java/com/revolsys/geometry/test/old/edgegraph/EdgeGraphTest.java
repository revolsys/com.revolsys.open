...
public class EdgeGraphTest extends TestCase {
  ...
  public void testNode() throws Exception {
    ...
    checkEdgeRing(graph, new PointDouble((double)0, 0), new Point[] {
      new PointDouble((double)1, 0),
      new PointDouble((double)0, 1),
      new PointDouble((double)-1, 0)
    });
    checkEdge(graph, new PointDouble((double)0, 0),
      new PointDouble((double)1, 0));
  }
