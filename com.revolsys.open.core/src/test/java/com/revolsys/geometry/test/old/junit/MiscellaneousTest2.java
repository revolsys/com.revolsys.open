...
public class MiscellaneousTest2 extends TestCase {
  ...
  public void testCoordinateHash() {
    doTestCoordinateHash(true, new PointDouble(1, 2), new PointDouble(1, 2));
    doTestCoordinateHash(false, new PointDouble(1, 2), new PointDouble(3, 4));
    doTestCoordinateHash(false, new PointDouble(1, 2), new PointDouble(1, 4));
    doTestCoordinateHash(false, new PointDouble(1, 2), new PointDouble(3, 2));
    doTestCoordinateHash(false, new PointDouble(1, 2), new PointDouble(2, 1));
  }

  public void testDirectedEdgeComparator() {
    final DirectedEdge d1 = new DirectedEdge(new Node(new PointDouble(0, 0)),
      new Node(new PointDouble(10, 10)), new PointDouble(10, 10), true);
    final DirectedEdge d2 = new DirectedEdge(new Node(new PointDouble(0, 0)),
      new Node(new PointDouble(20, 20)), new PointDouble(20, 20), false);
  ...
  public void testDirectedEdgeToEdges() {
    final DirectedEdge d1 = new DirectedEdge(new Node(new PointDouble(0, 0)),
      new Node(new PointDouble(10, 10)), new PointDouble(10, 10), true);
    final DirectedEdge d2 = new DirectedEdge(new Node(new PointDouble(20, 0)),
      new Node(new PointDouble(20, 10)), new PointDouble(20, 10), false);
  ...
  public void testNoOutgoingDirEdgeFoundException() throws Exception {
    final Geometry a = new WKTReader().read(
    ...
    final Geometry b = new WKTReader().read(
  ...
  public void testPointLocator() throws Exception {
    ...
    assertEquals(Location.EXTERIOR, pointLocator.locate(new PointDouble(420, 340), polygon));
    assertEquals(Location.BOUNDARY, pointLocator.locate(new PointDouble(350, 50), polygon));
    assertEquals(Location.BOUNDARY, pointLocator.locate(new PointDouble(410, 50), polygon));
    assertEquals(Location.INTERIOR, pointLocator.locate(new PointDouble(190, 150), polygon));
  }
  ...
  public void testPointLocatorLinearRingLineString() throws Exception {
    ...
    assertEquals(Location.BOUNDARY, pointLocator.locate(new PointDouble(10, 10), gc));
  }
  ...
  public void testUniqueCoordinateArrayFilter() throws Exception {
    ...
    assertEquals(new PointDouble(10, 10), coordinates[0]);
    assertEquals(new PointDouble(20, 20), coordinates[1]);
    assertEquals(new PointDouble(30, 30), coordinates[2]);
  }
