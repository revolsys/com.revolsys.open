...
public class MiscellaneousTest2 extends TestCase {
  ...
  public void test1() throws Exception {
    ...
    assertTrue(CGAlgorithms.isOnLine(new Coordinate(10, 10), new Coordinate[] {
      new Coordinate(0, 10), new Coordinate(20, 10)
    }));
    assertTrue(!CGAlgorithms.isOnLine(new Coordinate(30, 10), new Coordinate[] {
      new Coordinate(0, 10), new Coordinate(20, 10)
    }));
  }
  ...
  public void testDirectedEdgeComparator() {
    final DirectedEdge d1 = new DirectedEdge(new Node(new Coordinate(0, 0)),
      new Node(new Coordinate(10, 10)), new Coordinate(10, 10), true);
    final DirectedEdge d2 = new DirectedEdge(new Node(new Coordinate(0, 0)),
  ...
  public void testDirectedEdgeToEdges() {
    final DirectedEdge d1 = new DirectedEdge(new Node(new Coordinate(0, 0)),
      new Node(new Coordinate(10, 10)), new Coordinate(10, 10), true);
    final DirectedEdge d2 = new DirectedEdge(new Node(new Coordinate(20, 0)),
  ...
  public void testPointLocator() throws Exception {
    ...
    assertEquals(Location.EXTERIOR,
      pointLocator.locate(new Coordinate(420, 340), polygon));
    assertEquals(Location.BOUNDARY,
      pointLocator.locate(new Coordinate(350, 50), polygon));
    assertEquals(Location.BOUNDARY,
      pointLocator.locate(new Coordinate(410, 50), polygon));
    assertEquals(Location.INTERIOR,
      pointLocator.locate(new Coordinate(190, 150), polygon));
  }
  ...
  public void testPointLocatorLinearRingLineString() throws Exception {
    ...
    assertEquals(Location.BOUNDARY,
      pointLocator.locate(new Coordinate(10, 10), gc));
  }
