...
public class VectorOfFieldDef {
  ...
  public void add(final FieldDef x) {
    EsriFileGdbJNI.VectorOfFieldDef_add(this.swigCPtr, this,
      FieldDef.getCPtr(x), x);
  }
  ...
  public FieldDef get(final int i) {
    return new FieldDef(EsriFileGdbJNI.VectorOfFieldDef_get(this.swigCPtr,
      this, i), false);
  }
  ...
  public void set(final int i, final FieldDef val) {
    EsriFileGdbJNI.VectorOfFieldDef_set(this.swigCPtr, this, i,
