...
public class EsriFileGdbJNI {
  ...
  public final static native int EnumRows_GetFieldInformation(long jarg1, EnumRows jarg1_,
    long jarg2, FieldInfo jarg2_);
  ...
  public final static native void Geodatabase_createFeatureDataset(long jarg1, Geodatabase jarg1_,
    String jarg2);

  public final static native long Geodatabase_createTable(long jarg1, Geodatabase jarg1_,
    String jarg2, String jarg3);

  public final static native int Geodatabase_Delete(long jarg1, Geodatabase jarg1_, String jarg2,
    String jarg3);

  public final static native void Geodatabase_deleteDomain(long jarg1, Geodatabase jarg1_,
    String jarg2);

  public final static native int Geodatabase_GetChildDatasetDefinitions(long jarg1,
    Geodatabase jarg1_, String jarg2, String jarg3, long jarg4, VectorOfString jarg4_);
  ...
  public final static native int Geodatabase_GetDatasetRelationshipTypes(long jarg1,
    Geodatabase jarg1_, long jarg2, VectorOfWString jarg2_);

  public final static native int Geodatabase_GetDatasetTypes(long jarg1, Geodatabase jarg1_,
    long jarg2, VectorOfWString jarg2_);

  public final static native String Geodatabase_getDomainDefinition(long jarg1, Geodatabase jarg1_,
    String jarg2);

  public final static native long Geodatabase_getDomains(long jarg1, Geodatabase jarg1_);

  public final static native String Geodatabase_getQueryName(long jarg1, Geodatabase jarg1_,
    String jarg2);
  ...
  public final static native String Geodatabase_getTableDefinition(long jarg1, Geodatabase jarg1_,
    String jarg2);
  ...
  public final static native int Geodatabase_Rename(long jarg1, Geodatabase jarg1_, String jarg2,
  ...
  public final static native long new_Envelope__SWIG_1(double jarg1, double jarg2, double jarg3,
    double jarg4);
  ...
  public final static native int Row_GetFieldInformation(long jarg1, Row jarg1_, long jarg2,
    FieldInfo jarg2_);
  ...
  public final static native void Row_setGuid(long jarg1, Row jarg1_, String jarg2, long jarg3,
    Guid jarg3_);
  ...
  public final static native int Table_AddField__SWIG_1(long jarg1, Table jarg1_, long jarg2,
    FieldDef jarg2_);

  public final static native int Table_AddIndex__SWIG_0(long jarg1, Table jarg1_, String jarg2);

  public final static native int Table_AddIndex__SWIG_1(long jarg1, Table jarg1_, long jarg2,
    IndexDef jarg2_);
  ...
  public final static native int Table_EnableSubtypes(long jarg1, Table jarg1_, String jarg2,
    String jarg3);
  ...
  public final static native int Table_GetExtent(long jarg1, Table jarg1_, long jarg2,
    Envelope jarg2_);

  public final static native int Table_GetFieldInformation(long jarg1, Table jarg1_, long jarg2,
    FieldInfo jarg2_);
  ...
  public final static native long Table_search__SWIG_0(long jarg1, Table jarg1_, String jarg2,
    String jarg3, long jarg4, Envelope jarg4_, boolean jarg5);

  public final static native long Table_search__SWIG_1(long jarg1, Table jarg1_, String jarg2,
    String jarg3, boolean jarg4);
  ...
  public final static native void VectorOfFieldDef_add(long jarg1, VectorOfFieldDef jarg1_,
    long jarg2, FieldDef jarg2_);
  ...
  public final static native long VectorOfFieldDef_get(long jarg1, VectorOfFieldDef jarg1_,
    int jarg2);

  public final static native boolean VectorOfFieldDef_isEmpty(long jarg1, VectorOfFieldDef jarg1_);

  public final static native void VectorOfFieldDef_reserve(long jarg1, VectorOfFieldDef jarg1_,
    long jarg2);

  public final static native void VectorOfFieldDef_set(long jarg1, VectorOfFieldDef jarg1_,
    int jarg2, long jarg3, FieldDef jarg3_);
  ...
  public final static native void VectorOfString_reserve(long jarg1, VectorOfString jarg1_,
    long jarg2);

  public final static native void VectorOfString_set(long jarg1, VectorOfString jarg1_, int jarg2,
    String jarg3);

  public final static native long VectorOfString_size(long jarg1, VectorOfString jarg1_);

  public final static native void VectorOfWString_add(long jarg1, VectorOfWString jarg1_,
    String jarg2);
  ...
  public final static native String VectorOfWString_get(long jarg1, VectorOfWString jarg1_,
    int jarg2);
