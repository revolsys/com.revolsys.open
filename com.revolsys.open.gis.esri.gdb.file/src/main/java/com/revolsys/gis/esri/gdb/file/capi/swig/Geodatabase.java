...
public class Geodatabase {
  ...
  public void alterDomain(final String domainDefinition) {
    EsriFileGdbJNI.Geodatabase_alterDomain(this.swigCPtr, this,
      domainDefinition);
  }

  public void closeTable(final Table table) {
    EsriFileGdbJNI.Geodatabase_closeTable(this.swigCPtr, this,
      Table.getCPtr(table), table);
  }

  public void createDomain(final String domainDefinition) {
    EsriFileGdbJNI.Geodatabase_createDomain(this.swigCPtr, this,
      domainDefinition);
  }

  public void createFeatureDataset(final String featureDatasetDef) {
    EsriFileGdbJNI.Geodatabase_createFeatureDataset(this.swigCPtr, this,
      featureDatasetDef);
  }

  public Table createTable(final String tableDefinition, final String parent) {
    final long cPtr = EsriFileGdbJNI.Geodatabase_createTable(this.swigCPtr,
      this, tableDefinition, parent);
  ...
  public int Delete(final String path, final String datasetType) {
    return EsriFileGdbJNI.Geodatabase_Delete(this.swigCPtr, this, path,
      datasetType);
  }
  ...
  public int GetChildDatasetDefinitions(final String parentPath,
    ...
    return EsriFileGdbJNI.Geodatabase_GetChildDatasetDefinitions(this.swigCPtr,
  ...
  public VectorOfWString getChildDatasets(final String parentPath,
    ...
    return new VectorOfWString(EsriFileGdbJNI.Geodatabase_getChildDatasets(
      this.swigCPtr, this, parentPath, datasetType), true);
  }

  public String getDatasetDefinition(final String path, final String datasetType) {
    return EsriFileGdbJNI.Geodatabase_getDatasetDefinition(this.swigCPtr, this,
      path, datasetType);
  }

  public String getDatasetDocumentation(final String path,
    final String datasetType) {
    return EsriFileGdbJNI.Geodatabase_getDatasetDocumentation(this.swigCPtr,
      this, path, datasetType);
  }

  public int GetDatasetRelationshipTypes(final VectorOfWString relationshipTypes) {
    return EsriFileGdbJNI.Geodatabase_GetDatasetRelationshipTypes(
      this.swigCPtr, this, VectorOfWString.getCPtr(relationshipTypes),
      relationshipTypes);
  }
  ...
  public String getDomainDefinition(final String domainName) {
    return EsriFileGdbJNI.Geodatabase_getDomainDefinition(this.swigCPtr, this,
      domainName);
  }

  public VectorOfWString getDomains() {
    return new VectorOfWString(EsriFileGdbJNI.Geodatabase_getDomains(
  ...
  public int GetRelatedDatasetDefinitions(final String path,
    ...
    return EsriFileGdbJNI.Geodatabase_GetRelatedDatasetDefinitions(
      this.swigCPtr, this, path, relType, datasetType,
  ...
  public int GetRelatedDatasets(final String path, final String relType,
    ...
    return EsriFileGdbJNI.Geodatabase_GetRelatedDatasets(this.swigCPtr, this,
      path, relType, datasetType, VectorOfWString.getCPtr(relatedDatasets),
      relatedDatasets);
  }

  public String getTableDefinition(final String path) {
    return EsriFileGdbJNI.Geodatabase_getTableDefinition(this.swigCPtr, this,
      path);
  }

  public int Move(final String path, final String newParentPath) {
    return EsriFileGdbJNI.Geodatabase_Move(this.swigCPtr, this, path,
      newParentPath);
  }

  public Table openTable(final String path) {
    final long cPtr = EsriFileGdbJNI.Geodatabase_openTable(this.swigCPtr, this,
      path);
    return cPtr == 0 ? null : new Table(cPtr, true);
  }

  public EnumRows query(final String sql, final boolean recycling) {
    final long cPtr = EsriFileGdbJNI.Geodatabase_query(this.swigCPtr, this,
      sql, recycling);
  ...
  public int Rename(final String path, final String datasetType,
    ...
    return EsriFileGdbJNI.Geodatabase_Rename(this.swigCPtr, this, path,
      datasetType, newName);
  }
