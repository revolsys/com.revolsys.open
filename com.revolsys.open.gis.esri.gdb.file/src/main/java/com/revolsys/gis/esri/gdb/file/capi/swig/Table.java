...
public class Table {
  ...
  public int EnableSubtypes(final String subtypeFieldName,
    ...
    return EsriFileGdbJNI.Table_EnableSubtypes(this.swigCPtr, this,
  ...
  public VectorOfString getIndexes() {
    return new VectorOfString(EsriFileGdbJNI.Table_getIndexes(this.swigCPtr,
      this), true);
  }
  ...
  public EnumRows search(final String subfields, final String whereClause,
    ...
    final long cPtr = EsriFileGdbJNI.Table_search__SWIG_1(this.swigCPtr, this,
  ...
  public EnumRows search(final String subfields, final String whereClause,
    ...
    final long cPtr = EsriFileGdbJNI.Table_search__SWIG_0(this.swigCPtr, this,
      subfields, whereClause, Envelope.getCPtr(envelope), envelope, recycling);
    return cPtr == 0 ? null : new EnumRows(cPtr, true);
  }

  public int SetDefaultSubtypeCode(final int defaultCode) {
    return EsriFileGdbJNI.Table_SetDefaultSubtypeCode(this.swigCPtr, this,
      defaultCode);
  }

  public int SetDocumentation(final String documentation) {
    return EsriFileGdbJNI.Table_SetDocumentation(this.swigCPtr, this,
      documentation);
  }
