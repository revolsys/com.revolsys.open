...
public class PostgreSQLDataObjectStore extends AbstractJdbcDataObjectStore {
  ...
  public void initialize() {
    ...
    setPrimaryKeySql("select p.table_name,c.column_name from information_schema.table_constraints p join information_schema.constraint_column_usage c using (table_schema, table_name) where p.constraint_type = 'PRIMARY KEY' and p.table_schema = ?");
