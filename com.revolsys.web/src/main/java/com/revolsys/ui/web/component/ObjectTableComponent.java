...
public class ObjectTableComponent {
  ...
  public void setProperty(final String name, final Object value) {
    ...
    } else if (name.equals("list") && value instanceof Collection) {
  ...
  public final void serialize(final Writer out) throws IOException {
    if (list != null) {
      builder.createTableView(list, cssClass, title, "list",
        Locale.getDefault()).serialize(out);
    }
  }
}
