...
public final class GDALUtilities {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger("it.geosolutions.imageio.gdalframework");
  ...
  public static ColorModel buildColorModel(final SampleModel sampleModel) {
    ...
    if (numBands > 1) {
      ...
      if (colorModel == null) {
        LOGGER.error("No ColorModels found");
      }
  ...
  //
  public static String buildCRSProperties(final RenderedImage ri,
    final int index) {
    final Object imageReader = ri.getProperty(ImageReadDescriptor.PROPERTY_NAME_IMAGE_READER);
    final StringBuffer sb = new StringBuffer("CRS Information:").append(newLine);
  ...
  // and return the String containing properly formatted text.
  //
  public static String buildMetadataText(final RenderedImage ri,
   ...
   */
  public static void closeDataSet(final Dataset ds) {
    if (ds == null) {
   ...
   */
  public static DriverCreateCapabilities formatWritingCapabilities(
    ...
    synchronized (driversWritingCapabilities) {
      ...
      try {
        ...
        final DriverCreateCapabilities retVal;
        if (createSupported) {
          driversWritingCapabilities.put(driverName,
   ...
   */
  public static List<String> getGDALImageMetadata(final String dataSetName) {
   ...
   */
  public static List getGDALStreamMetadata(final String datasetName) {
    Dataset ds = null;
    try {
  ...
  public static String getImageMetadata(final GDALImageReader reader,
    final int index) {
    ...
    if (metadata != null) {
      ...
      final StringBuffer sb = new StringBuffer("Image Metadata:").append(newLine);
      for (int i = 0; i < size; i++) {
  ...
  public static List getJDKImageReaderWriterSPI(final ServiceRegistry registry,
    final String formatName, final boolean isReader) {
   ...
   */
  public static String getMetadataItem(final List imageMetadata,
  ...
  //
  public static String getStreamMetadata(final GDALImageReader reader)
    throws IOException {
    ...
    if (metadata != null) {
      final int size = metadata.size();
      final StringBuffer sb = new StringBuffer("Stream Metadata:").append(newLine);
      for (int i = 0; i < size; i++) {
        sb.append(metadata.get(i)).append(newLine);
      }
      return sb.toString();
   ...
   */
  public static String getStreamMetadataItem(final String metadataName,
  ...
  public static boolean isDriverAvailable(final String driverName) {
    ...
    try {
      ...
      if (LOGGER.isWarnEnabled()) {
        LOGGER.warn("Failed to get the specified GDAL Driver: " + driverName
    ...
    if (init == false) {
      synchronized (LOGGER) {
        ...
        try {
          ...
          if (LOGGER.isWarnEnabled()) {
            LOGGER.warn("Failed to load the GDAL native libs. This is not a problem "
   ...
   * @param maxCacheSize
   */
  public static void setCacheMax(final int maxCacheSize) {
   ...
   */
  public static void setGdalCaching(final boolean useCaching) {
   ...
   *                to disable GDAL PAM.
   */
  public static void setGdalPAM(final boolean usePAM) {
   ...
   */
  public static void setNodeAttribute(final String name, final Object val,
    final IIOMetadataNode node, final int attributeType) {
    ...
    try {
      ...
      LOGGER.debug("The specified value has not been successfully parsed: "
        + (String)val);
    }
