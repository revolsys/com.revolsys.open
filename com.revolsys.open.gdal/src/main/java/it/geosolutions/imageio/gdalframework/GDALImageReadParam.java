...
public class GDALImageReadParam extends ImageReadParam {
  ...
  public enum ResampleAlgorithm {
    NEAREST_NEIGHBOUR(gdalconst.GRA_NearestNeighbour), BILINEAR(
      gdalconst.GRA_Bilinear), CUBIC(gdalconst.GRA_Cubic), CUBIC_SPLINE(
     ...
     * 
     */
    private final int gdalResampleAlgorithm;

    private ResampleAlgorithm(final int gdalResampleAlgorithm) {
   ...
   */
  public void setDestinationWkt(final String destinationWkt) {
   ...
   * 
   */
  public void setResampleAlgorithm(final ResampleAlgorithm resampleAlgorithm) {
