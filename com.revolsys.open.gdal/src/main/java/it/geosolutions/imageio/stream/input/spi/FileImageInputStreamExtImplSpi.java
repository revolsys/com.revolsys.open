...
public class FileImageInputStreamExtImplSpi extends ImageInputStreamSpi {
  ...
  /** Logger. */
  private final static Logger LOGGER = Logger.getLogger("it.geosolutions.imageio.stream.input.spi");
  ...
  public static void setUseFileChannel(final boolean useFileChannel) {
  ...
  public void onRegistration(final ServiceRegistry registry,
    ...
    final Class<ImageInputStreamSpi> targetClass = ImageInputStreamSpi.class;
    for (final Iterator<? extends ImageInputStreamSpi> i = registry.getServiceProviders(
