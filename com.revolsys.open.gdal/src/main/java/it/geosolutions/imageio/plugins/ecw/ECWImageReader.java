...
public class ECWImageReader extends GDALImageReader {
  ...
  public ECWImageReader(final ECWImageReaderSpi originatingProvider) {
  ...
  public void setInput(final Object input, final boolean seekForwardOnly,
    ...
    if (input != null && input instanceof ECWPImageInputStream) {
      try {
        final boolean isDecodable = ((GDALImageReaderSpi)this.getOriginatingProvider()).canDecodeInput(input);
        if (isDecodable) {
