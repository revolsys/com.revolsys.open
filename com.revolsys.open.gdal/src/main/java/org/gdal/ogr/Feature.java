...
public class Feature implements Cloneable {
  ...
  public void GetFieldAsDateTime(final int id, final int[] pnYear, final int[] pnMonth, final int[] pnDay, final int[] pnHour, final int[] pnMinute, final int[] pnSecond, final int[] pnTZFlag) {
  ...
  public void SetField(final int id, final int year, final int month, final int day, final int hour, final int minute, final int second, final int tzflag) {
  ...
  public void SetField(final String name, final int year, final int month, final int day, final int hour, final int minute, final int second, final int tzflag) {
  ...
  public int SetGeometryDirectly(final Geometry geom) {
    final int ret = ogrJNI.Feature_SetGeometryDirectly(this.swigCPtr, this, Geometry.getCPtrAndDisown(geom), geom);
    if (geom != null) {
