...
public class ogr implements ogrConstants {
  public static Geometry ApproximateArcAngles(final double dfCenterX,
    final double dfCenterY, final double dfZ, final double dfPrimaryRadius,
    final double dfSecondaryAxis, final double dfRotation,
    final double dfStartAngle, final double dfEndAngle,
    final double dfMaxAngleStepSizeDegrees) {
    final long cPtr = ogrJNI.ApproximateArcAngles(dfCenterX, dfCenterY, dfZ,
      dfPrimaryRadius, dfSecondaryAxis, dfRotation, dfStartAngle, dfEndAngle,
  ...
  public static Geometry BuildPolygonFromEdges(final Geometry hLineCollection) {
    final long cPtr = ogrJNI.BuildPolygonFromEdges__SWIG_3(
      Geometry.getCPtr(hLineCollection), hLineCollection);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }

  public static Geometry BuildPolygonFromEdges(final Geometry hLineCollection,
    final int bBestEffort) {
    final long cPtr = ogrJNI.BuildPolygonFromEdges__SWIG_2(
      Geometry.getCPtr(hLineCollection), hLineCollection, bBestEffort);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }

  public static Geometry BuildPolygonFromEdges(final Geometry hLineCollection,
    final int bBestEffort, final int bAutoClose) {
    final long cPtr = ogrJNI.BuildPolygonFromEdges__SWIG_1(
      Geometry.getCPtr(hLineCollection), hLineCollection, bBestEffort,
      bAutoClose);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }
  ...
  public static Geometry BuildPolygonFromEdges(final Geometry hLineCollection,
    ...
    final long cPtr = ogrJNI.BuildPolygonFromEdges__SWIG_0(
      Geometry.getCPtr(hLineCollection), hLineCollection, bBestEffort,
      bAutoClose, dfTolerance);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }
  ...
  public static Geometry ForceToLineString(final Geometry geom_in) {
    final long cPtr = ogrJNI.ForceToLineString(Geometry.getCPtr(geom_in),
      geom_in);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }

  public static Geometry ForceToMultiLineString(final Geometry geom_in) {
    final long cPtr = ogrJNI.ForceToMultiLineString(Geometry.getCPtr(geom_in),
      geom_in);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }

  public static Geometry ForceToMultiPoint(final Geometry geom_in) {
    final long cPtr = ogrJNI.ForceToMultiPoint(Geometry.getCPtr(geom_in),
      geom_in);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }

  public static Geometry ForceToMultiPolygon(final Geometry geom_in) {
    final long cPtr = ogrJNI.ForceToMultiPolygon(Geometry.getCPtr(geom_in),
      geom_in);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }
  ...
  public static int SetGenerate_DB2_V72_BYTE_ORDER(
    final int bGenerate_DB2_V72_BYTE_ORDER) {
