...
public class Geometry implements Cloneable {
  ...
  public int AddGeometryDirectly(final Geometry other_disown) {
    final int ret = ogrJNI.Geometry_AddGeometryDirectly(this.swigCPtr, this, Geometry.getCPtrAndDisown(other_disown), other_disown);
  ...
  public Geometry Difference(final Geometry other) {
    final long cPtr = ogrJNI.Geometry_Difference(this.swigCPtr, this, Geometry.getCPtr(other), other);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }
  ...
  public Geometry Intersection(final Geometry other) {
    final long cPtr = ogrJNI.Geometry_Intersection(this.swigCPtr, this, Geometry.getCPtr(other), other);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }
  ...
  public Geometry SymDifference(final Geometry other) {
    final long cPtr = ogrJNI.Geometry_SymDifference(this.swigCPtr, this, Geometry.getCPtr(other), other);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }

  public Geometry SymmetricDifference(final Geometry other) {
    final long cPtr = ogrJNI.Geometry_SymmetricDifference(this.swigCPtr, this, Geometry.getCPtr(other), other);
    return cPtr == 0 ? null : new Geometry(cPtr, true);
  }
