...
public class Driver {
  ...
  public DataSource CopyDataSource(final DataSource copy_ds, final String utf8_path) {
    final long cPtr = ogrJNI.Driver_CopyDataSource__SWIG_1(this.swigCPtr, this, DataSource.getCPtr(copy_ds), copy_ds, utf8_path);
    return cPtr == 0 ? null : new DataSource(cPtr, true);
  }

  public DataSource CopyDataSource(final DataSource copy_ds, final String utf8_path, final java.util.Vector options) {
    final long cPtr = ogrJNI.Driver_CopyDataSource__SWIG_0(this.swigCPtr, this, DataSource.getCPtr(copy_ds), copy_ds, utf8_path, options);
    return cPtr == 0 ? null : new DataSource(cPtr, true);
  }

  public DataSource CreateDataSource(final String utf8_path) {
    final long cPtr = ogrJNI.Driver_CreateDataSource__SWIG_1(this.swigCPtr, this, utf8_path);
    return cPtr == 0 ? null : new DataSource(cPtr, true);
  }


  public DataSource CreateDataSource(final String utf8_path, final java.util.Vector options) {
    final long cPtr = ogrJNI.Driver_CreateDataSource__SWIG_0(this.swigCPtr, this, utf8_path, options);
    return cPtr == 0 ? null : new DataSource(cPtr, true);
  }
  ...
  public DataSource Open(final String utf8_path, final int update) {
    final long cPtr = ogrJNI.Driver_Open__SWIG_0(this.swigCPtr, this, utf8_path, update);
    return cPtr == 0 ? null : new DataSource(cPtr, true);
  }
