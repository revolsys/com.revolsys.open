...
public final class XMLNodeType {
  ...
  public final static XMLNodeType CXT_Text = new XMLNodeType("CXT_Text",
    gdalJNI.CXT_Text_get());

  public final static XMLNodeType CXT_Attribute = new XMLNodeType(
    "CXT_Attribute", gdalJNI.CXT_Attribute_get());
  ...
  public static XMLNodeType swigToEnum(final int swigValue) {
    ...
    throw new IllegalArgumentException("No enum " + XMLNodeType.class
