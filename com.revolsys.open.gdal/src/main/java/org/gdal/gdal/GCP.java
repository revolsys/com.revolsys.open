...
public class GCP {
  ...
  public GCP(final double x, final double y, final double z, final double pixel, final double line, final String info, final String id) {
    this(gdalJNI.new_GCP(x, y, z, pixel, line, info, id), true);
  }

  public GCP(final double x, final double y, final double pixel, final double line, final String info, final String id)
  {
