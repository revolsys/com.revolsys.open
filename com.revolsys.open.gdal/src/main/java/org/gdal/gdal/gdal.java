...
public class gdal {
  ...
  public static void ApplyGeoTransform(final double[] padfGeoTransform,
    final double dfPixel, final double dfLine, final double[] pdfGeoX,
    final double[] pdfGeoY) {
    gdalJNI.ApplyGeoTransform(padfGeoTransform, dfPixel, dfLine, pdfGeoX,
      pdfGeoY);
  }

  public static Dataset AutoCreateWarpedVRT(final Dataset src_ds) {
    final long cPtr = gdalJNI.AutoCreateWarpedVRT__SWIG_4(
      Dataset.getCPtr(src_ds), src_ds);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public static Dataset AutoCreateWarpedVRT(final Dataset src_ds,
    final String src_wkt) {
    final long cPtr = gdalJNI.AutoCreateWarpedVRT__SWIG_3(
      Dataset.getCPtr(src_ds), src_ds, src_wkt);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public static Dataset AutoCreateWarpedVRT(final Dataset src_ds,
    final String src_wkt, final String dst_wkt) {
    final long cPtr = gdalJNI.AutoCreateWarpedVRT__SWIG_2(
      Dataset.getCPtr(src_ds), src_ds, src_wkt, dst_wkt);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public static Dataset AutoCreateWarpedVRT(final Dataset src_ds,
    final String src_wkt, final String dst_wkt, final int eResampleAlg) {
    final long cPtr = gdalJNI.AutoCreateWarpedVRT__SWIG_1(
      Dataset.getCPtr(src_ds), src_ds, src_wkt, dst_wkt, eResampleAlg);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }
  ...
  public static Dataset AutoCreateWarpedVRT(final Dataset src_ds,
    ...
    final long cPtr = gdalJNI.AutoCreateWarpedVRT__SWIG_0(
      Dataset.getCPtr(src_ds), src_ds, src_wkt, dst_wkt, eResampleAlg, maxerror);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public static int ComputeMedianCutPCT(final Band red, final Band green,
    final Band blue, final int num_colors, final ColorTable colors) {
    return gdalJNI.ComputeMedianCutPCT__SWIG_2(Band.getCPtr(red), red,
      Band.getCPtr(green), green, Band.getCPtr(blue), blue, num_colors,
      ColorTable.getCPtr(colors), colors);
  }

  public static int ComputeMedianCutPCT(final Band red, final Band green,
    final Band blue, final int num_colors, final ColorTable colors,
    final ProgressCallback callback) {
    return gdalJNI.ComputeMedianCutPCT__SWIG_0(Band.getCPtr(red), red,
      Band.getCPtr(green), green, Band.getCPtr(blue), blue, num_colors,
      ColorTable.getCPtr(colors), colors, callback);
  }

  public static int ComputeProximity(final Band srcBand,
    final Band proximityBand) {
    return gdalJNI.ComputeProximity__SWIG_3(Band.getCPtr(srcBand), srcBand,
      Band.getCPtr(proximityBand), proximityBand);
  }

  public static int ComputeProximity(final Band srcBand,
    final Band proximityBand, final java.util.Vector options) {
  ...
  public static int ContourGenerate(final Band srcBand,
    final double contourInterval, final double contourBase,
    final double[] fixedLevelCount, final int useNoData,
    final double noDataValue, final org.gdal.ogr.Layer dstLayer,
    final int idField, final int elevField) {
    return gdalJNI.ContourGenerate__SWIG_2(Band.getCPtr(srcBand), srcBand,
      contourInterval, contourBase, fixedLevelCount, useNoData, noDataValue,
      dstLayer, idField, elevField);
  }
  ...
  public static int ContourGenerate(final Band srcBand,
    ...
    final double[] fixedLevelCount, final int useNoData,
    final double noDataValue, final org.gdal.ogr.Layer dstLayer,
    final int idField, final int elevField, final ProgressCallback callback) {
    return gdalJNI.ContourGenerate__SWIG_0(Band.getCPtr(srcBand), srcBand,
      contourInterval, contourBase, fixedLevelCount, useNoData, noDataValue,
      dstLayer, idField, elevField, callback);
  }
  ...
  public static int DitherRGB2PCT(final Band red, final Band green,
    final Band blue, final Band target, final ColorTable colors) {
    return gdalJNI.DitherRGB2PCT__SWIG_2(Band.getCPtr(red), red,
      Band.getCPtr(green), green, Band.getCPtr(blue), blue,
      Band.getCPtr(target), target, ColorTable.getCPtr(colors), colors);
  }

  public static int DitherRGB2PCT(final Band red, final Band green,
    final Band blue, final Band target, final ColorTable colors,
    final ProgressCallback callback) {
    return gdalJNI.DitherRGB2PCT__SWIG_0(Band.getCPtr(red), red,
      Band.getCPtr(green), green, Band.getCPtr(blue), blue,
      Band.getCPtr(target), target, ColorTable.getCPtr(colors), colors,
      callback);
  }

  public static void Error(final int msg_class, final int err_code,
    final String msg) {
  ...
  public static void FileFromMemBuffer(final String utf8_path,
    final byte[] nBytes) {
  ...
  public static int FillNodata(final Band targetBand, final Band maskBand,
    ...
    return gdalJNI.FillNodata__SWIG_3(Band.getCPtr(targetBand), targetBand,
      Band.getCPtr(maskBand), maskBand, maxSearchDist, smoothingIterations);
  }

  public static int FillNodata(final Band targetBand, final Band maskBand,
    final double maxSearchDist, final int smoothingIterations,
    final java.util.Vector options) {
    return gdalJNI.FillNodata__SWIG_2(Band.getCPtr(targetBand), targetBand,
      Band.getCPtr(maskBand), maskBand, maxSearchDist, smoothingIterations,
      options);
  }
  ...
  public static int FillNodata(final Band targetBand, final Band maskBand,
    ...
    return gdalJNI.FillNodata__SWIG_0(Band.getCPtr(targetBand), targetBand,
      Band.getCPtr(maskBand), maskBand, maxSearchDist, smoothingIterations,
      options, callback);
  }
  ...
  public static int GCPsToGeoTransform(final GCP[] nGCPs,
    final double[] argout, final int bApproxOK) {
  ...
  public static void GDAL_GCP_GCPPixel_set(final GCP gcp,
    final double dfGCPPixel) {
  ...
  public static void GDAL_GCP_set_GCPPixel(final GCP gcp,
    final double dfGCPPixel) {
  ...
  public static java.util.Vector GeneralCmdLineProcessor(
    final java.util.Vector papszArgv) {
    return gdalJNI.GeneralCmdLineProcessor__SWIG_1(papszArgv);
  }

  public static java.util.Vector GeneralCmdLineProcessor(
    final java.util.Vector papszArgv, final int nOptions) {
  ...
  public static String GOA2GetAccessToken(final String pszRefreshToken,
    final String pszScope) {
  ...
  public static String GOA2GetRefreshToken(final String pszAuthToken,
    final String pszScope) {
    return gdalJNI.GOA2GetRefreshToken(pszAuthToken, pszScope);
  }

  public static int GridCreate(final String algorithmOptions,
    final double[][] points, final double xMin, final double xMax,
    final double yMin, final double yMax, final int xSize, final int ySize,
    final int dataType, final java.nio.ByteBuffer nioBuffer) {
    return gdalJNI.GridCreate__SWIG_2(algorithmOptions, points, xMin, xMax,
      yMin, yMax, xSize, ySize, dataType, nioBuffer);
  }
  ...
  public static int GridCreate(final String algorithmOptions,
    ...
    final int dataType, final java.nio.ByteBuffer nioBuffer,
    final ProgressCallback callback) {
    return gdalJNI.GridCreate__SWIG_0(algorithmOptions, points, xMin, xMax,
      yMin, yMax, xSize, ySize, dataType, nioBuffer, callback);
  }
  ...
  public static int Polygonize(final Band srcBand, final Band maskBand,
    ...
    return gdalJNI.Polygonize__SWIG_3(Band.getCPtr(srcBand), srcBand,
      Band.getCPtr(maskBand), maskBand, outLayer, iPixValField);
  }

  public static int Polygonize(final Band srcBand, final Band maskBand,
    final org.gdal.ogr.Layer outLayer, final int iPixValField,
    final java.util.Vector options) {
    return gdalJNI.Polygonize__SWIG_2(Band.getCPtr(srcBand), srcBand,
      Band.getCPtr(maskBand), maskBand, outLayer, iPixValField, options);
  }

  public static int Polygonize(final Band srcBand, final Band maskBand,
    final org.gdal.ogr.Layer outLayer, final int iPixValField,
    final java.util.Vector options, final ProgressCallback callback) {
    return gdalJNI.Polygonize__SWIG_0(Band.getCPtr(srcBand), srcBand,
      Band.getCPtr(maskBand), maskBand, outLayer, iPixValField, options,
      callback);
  }
  ...
  public static int RasterizeLayer(final Dataset dataset, final int[] bands,
    ...
    return gdalJNI.RasterizeLayer__SWIG_5(Dataset.getCPtr(dataset), dataset,
      bands, layer);
  }

  public static int RasterizeLayer(final Dataset dataset, final int[] bands,
    final org.gdal.ogr.Layer layer, final double[] burn_values) {
    return gdalJNI.RasterizeLayer__SWIG_3(Dataset.getCPtr(dataset), dataset,
      bands, layer, burn_values);
  }

  public static int RasterizeLayer(final Dataset dataset, final int[] bands,
    final org.gdal.ogr.Layer layer, final double[] burn_values,
    final java.util.Vector options) {
    return gdalJNI.RasterizeLayer__SWIG_2(Dataset.getCPtr(dataset), dataset,
      bands, layer, burn_values, options);
  }

  public static int RasterizeLayer(final Dataset dataset, final int[] bands,
    final org.gdal.ogr.Layer layer, final double[] burn_values,
    final java.util.Vector options, final ProgressCallback callback) {
    return gdalJNI.RasterizeLayer__SWIG_0(Dataset.getCPtr(dataset), dataset,
      bands, layer, burn_values, options, callback);
  }
  ...
  public static int RegenerateOverview(final Band srcBand,
    final Band overviewBand) {
    return gdalJNI.RegenerateOverview__SWIG_3(Band.getCPtr(srcBand), srcBand,
      Band.getCPtr(overviewBand), overviewBand);
  }

  public static int RegenerateOverview(final Band srcBand,
    final Band overviewBand, final String resampling) {
  ...
  public static int RegenerateOverviews(final Band srcBand,
    final Band[] overviewBandCount) {
    return gdalJNI.RegenerateOverviews__SWIG_3(Band.getCPtr(srcBand), srcBand,
      overviewBandCount);
  }

  public static int RegenerateOverviews(final Band srcBand,
    final Band[] overviewBandCount, final String resampling) {
    return gdalJNI.RegenerateOverviews__SWIG_2(Band.getCPtr(srcBand), srcBand,
      overviewBandCount, resampling);
  }

  public static int RegenerateOverviews(final Band srcBand,
    final Band[] overviewBandCount, final String resampling,
    final ProgressCallback callback) {
    return gdalJNI.RegenerateOverviews__SWIG_0(Band.getCPtr(srcBand), srcBand,
      overviewBandCount, resampling, callback);
  }
  ...
  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds) {
    return gdalJNI.ReprojectImage__SWIG_7(Dataset.getCPtr(src_ds), src_ds,
      Dataset.getCPtr(dst_ds), dst_ds);
  }

  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds,
    final String src_wkt) {
    return gdalJNI.ReprojectImage__SWIG_6(Dataset.getCPtr(src_ds), src_ds,
      Dataset.getCPtr(dst_ds), dst_ds, src_wkt);
  }

  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds,
    final String src_wkt, final String dst_wkt) {
    return gdalJNI.ReprojectImage__SWIG_5(Dataset.getCPtr(src_ds), src_ds,
      Dataset.getCPtr(dst_ds), dst_ds, src_wkt, dst_wkt);
  }

  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds,
    final String src_wkt, final String dst_wkt, final int eResampleAlg) {
    return gdalJNI.ReprojectImage__SWIG_4(Dataset.getCPtr(src_ds), src_ds,
      Dataset.getCPtr(dst_ds), dst_ds, src_wkt, dst_wkt, eResampleAlg);
  }

  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds,
    final String src_wkt, final String dst_wkt, final int eResampleAlg,
    final double WarpMemoryLimit) {
    return gdalJNI.ReprojectImage__SWIG_3(Dataset.getCPtr(src_ds), src_ds,
      Dataset.getCPtr(dst_ds), dst_ds, src_wkt, dst_wkt, eResampleAlg,
      WarpMemoryLimit);
  }
  ...
  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds,
    ...
    return gdalJNI.ReprojectImage__SWIG_2(Dataset.getCPtr(src_ds), src_ds,
      Dataset.getCPtr(dst_ds), dst_ds, src_wkt, dst_wkt, eResampleAlg,
      WarpMemoryLimit, maxerror);
  }
  ...
  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds,
    ...
    final double WarpMemoryLimit, final double maxerror,
    final ProgressCallback callback) {
    return gdalJNI.ReprojectImage__SWIG_0(Dataset.getCPtr(src_ds), src_ds,
      Dataset.getCPtr(dst_ds), dst_ds, src_wkt, dst_wkt, eResampleAlg,
      WarpMemoryLimit, maxerror, callback);
  }
  ...
  public static int SieveFilter(final Band srcBand, final Band maskBand,
    final Band dstBand, final int threshold) {
    return gdalJNI.SieveFilter__SWIG_4(Band.getCPtr(srcBand), srcBand,
      Band.getCPtr(maskBand), maskBand, Band.getCPtr(dstBand), dstBand,
      threshold);
  }

  public static int SieveFilter(final Band srcBand, final Band maskBand,
    final Band dstBand, final int threshold, final int connectedness) {
    return gdalJNI.SieveFilter__SWIG_3(Band.getCPtr(srcBand), srcBand,
      Band.getCPtr(maskBand), maskBand, Band.getCPtr(dstBand), dstBand,
  ...
  public static int SieveFilter(final Band srcBand, final Band maskBand,
    final Band dstBand, final int threshold, final int connectedness,
    final java.util.Vector options) {
    return gdalJNI.SieveFilter__SWIG_2(Band.getCPtr(srcBand), srcBand,
      Band.getCPtr(maskBand), maskBand, Band.getCPtr(dstBand), dstBand,
      threshold, connectedness, options);
  }

  public static int SieveFilter(final Band srcBand, final Band maskBand,
    final Band dstBand, final int threshold, final int connectedness,
    final java.util.Vector options, final ProgressCallback callback) {
    return gdalJNI.SieveFilter__SWIG_0(Band.getCPtr(srcBand), srcBand,
      Band.getCPtr(maskBand), maskBand, Band.getCPtr(dstBand), dstBand,
      threshold, connectedness, options, callback);
  }
