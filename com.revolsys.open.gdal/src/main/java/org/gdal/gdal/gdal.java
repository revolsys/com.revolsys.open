...
public class gdal {
  ...
  public static void ApplyGeoTransform(final double[] padfGeoTransform, final double dfPixel, final double dfLine, final double[] pdfGeoX, final double[] pdfGeoY) {
  ...
  public static Dataset AutoCreateWarpedVRT(final Dataset src_ds, final String src_wkt, final String dst_wkt) {
    final long cPtr = gdalJNI.AutoCreateWarpedVRT__SWIG_2(Dataset.getCPtr(src_ds), src_ds, src_wkt, dst_wkt);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public static Dataset AutoCreateWarpedVRT(final Dataset src_ds, final String src_wkt, final String dst_wkt, final int eResampleAlg) {
    final long cPtr = gdalJNI.AutoCreateWarpedVRT__SWIG_1(Dataset.getCPtr(src_ds), src_ds, src_wkt, dst_wkt, eResampleAlg);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public static Dataset AutoCreateWarpedVRT(final Dataset src_ds, final String src_wkt, final String dst_wkt, final int eResampleAlg, final double maxerror) {
    final long cPtr = gdalJNI.AutoCreateWarpedVRT__SWIG_0(Dataset.getCPtr(src_ds), src_ds, src_wkt, dst_wkt, eResampleAlg, maxerror);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public static int ComputeMedianCutPCT(final Band red, final Band green, final Band blue, final int num_colors, final ColorTable colors) {
  ...
  public static int ComputeMedianCutPCT(final Band red, final Band green, final Band blue, final int num_colors, final ColorTable colors, final ProgressCallback callback) {
  ...
  public static int ComputeProximity(final Band srcBand, final Band proximityBand, final java.util.Vector options) {
    return gdalJNI.ComputeProximity__SWIG_2(Band.getCPtr(srcBand), srcBand, Band.getCPtr(proximityBand), proximityBand, options);
  }

  public static int ComputeProximity(final Band srcBand, final Band proximityBand, final java.util.Vector options, final ProgressCallback callback) {
  ...
  public static int ContourGenerate(final Band srcBand, final double contourInterval, final double contourBase, final double[] fixedLevelCount, final int useNoData, final double noDataValue, final org.gdal.ogr.Layer dstLayer, final int idField, final int elevField) {
  ...
  public static int ContourGenerate(final Band srcBand, final double contourInterval, final double contourBase, final double[] fixedLevelCount, final int useNoData, final double noDataValue, final org.gdal.ogr.Layer dstLayer, final int idField, final int elevField, final ProgressCallback callback) {
  ...
  public static int DitherRGB2PCT(final Band red, final Band green, final Band blue, final Band target, final ColorTable colors) {
  ...
  public static int DitherRGB2PCT(final Band red, final Band green, final Band blue, final Band target, final ColorTable colors, final ProgressCallback callback) {
  ...
  public static int FillNodata(final Band targetBand, final Band maskBand, final double maxSearchDist, final int smoothingIterations) {
  ...
  public static int FillNodata(final Band targetBand, final Band maskBand, final double maxSearchDist, final int smoothingIterations, final java.util.Vector options) {
  ...
  public static int FillNodata(final Band targetBand, final Band maskBand, final double maxSearchDist, final int smoothingIterations, final java.util.Vector options, final ProgressCallback callback) {
  ...
  public static int GridCreate(final String algorithmOptions, final double[][] points, final double xMin, final double xMax, final double yMin, final double yMax, final int xSize, final int ySize, final int dataType, final java.nio.ByteBuffer nioBuffer) {
    return gdalJNI.GridCreate__SWIG_2(algorithmOptions, points, xMin, xMax, yMin, yMax, xSize, ySize, dataType, nioBuffer);
  }

  public static int GridCreate(final String algorithmOptions, final double[][] points, final double xMin, final double xMax, final double yMin, final double yMax, final int xSize, final int ySize, final int dataType, final java.nio.ByteBuffer nioBuffer, final ProgressCallback callback) {
  ...
  public static int Polygonize(final Band srcBand, final Band maskBand, final org.gdal.ogr.Layer outLayer, final int iPixValField) {
    return gdalJNI.Polygonize__SWIG_3(Band.getCPtr(srcBand), srcBand, Band.getCPtr(maskBand), maskBand, outLayer, iPixValField);
  }

  public static int Polygonize(final Band srcBand, final Band maskBand, final org.gdal.ogr.Layer outLayer, final int iPixValField, final java.util.Vector options) {
  ...
  public static int Polygonize(final Band srcBand, final Band maskBand, final org.gdal.ogr.Layer outLayer, final int iPixValField, final java.util.Vector options, final ProgressCallback callback) {
  ...
  public static int RasterizeLayer(final Dataset dataset, final int[] bands, final org.gdal.ogr.Layer layer) {
    return gdalJNI.RasterizeLayer__SWIG_5(Dataset.getCPtr(dataset), dataset, bands, layer);
  }

  public static int RasterizeLayer(final Dataset dataset, final int[] bands, final org.gdal.ogr.Layer layer, final double[] burn_values) {
    return gdalJNI.RasterizeLayer__SWIG_3(Dataset.getCPtr(dataset), dataset, bands, layer, burn_values);
  }

  public static int RasterizeLayer(final Dataset dataset, final int[] bands, final org.gdal.ogr.Layer layer, final double[] burn_values, final java.util.Vector options) {
    return gdalJNI.RasterizeLayer__SWIG_2(Dataset.getCPtr(dataset), dataset, bands, layer, burn_values, options);
  }

  public static int RasterizeLayer(final Dataset dataset, final int[] bands, final org.gdal.ogr.Layer layer, final double[] burn_values, final java.util.Vector options, final ProgressCallback callback) {
  ...
  public static int RegenerateOverview(final Band srcBand, final Band overviewBand, final String resampling) {
    return gdalJNI.RegenerateOverview__SWIG_2(Band.getCPtr(srcBand), srcBand, Band.getCPtr(overviewBand), overviewBand, resampling);
  }

  public static int RegenerateOverview(final Band srcBand, final Band overviewBand, final String resampling, final ProgressCallback callback) {
  ...
  public static int RegenerateOverviews(final Band srcBand, final Band[] overviewBandCount, final String resampling) {
    return gdalJNI.RegenerateOverviews__SWIG_2(Band.getCPtr(srcBand), srcBand, overviewBandCount, resampling);
  }

  public static int RegenerateOverviews(final Band srcBand, final Band[] overviewBandCount, final String resampling, final ProgressCallback callback) {
  ...
  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds, final String src_wkt, final String dst_wkt) {
    return gdalJNI.ReprojectImage__SWIG_5(Dataset.getCPtr(src_ds), src_ds, Dataset.getCPtr(dst_ds), dst_ds, src_wkt, dst_wkt);
  }

  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds, final String src_wkt, final String dst_wkt, final int eResampleAlg) {
  ...
  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds, final String src_wkt, final String dst_wkt, final int eResampleAlg, final double WarpMemoryLimit) {
  ...
  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds, final String src_wkt, final String dst_wkt, final int eResampleAlg, final double WarpMemoryLimit, final double maxerror) {
  ...
  public static int ReprojectImage(final Dataset src_ds, final Dataset dst_ds, final String src_wkt, final String dst_wkt, final int eResampleAlg, final double WarpMemoryLimit, final double maxerror, final ProgressCallback callback) {
  ...
  public static int SieveFilter(final Band srcBand, final Band maskBand, final Band dstBand, final int threshold) {
  ...
  public static int SieveFilter(final Band srcBand, final Band maskBand, final Band dstBand, final int threshold, final int connectedness) {
  ...
  public static int SieveFilter(final Band srcBand, final Band maskBand, final Band dstBand, final int threshold, final int connectedness, final java.util.Vector options) {
  ...
  public static int SieveFilter(final Band srcBand, final Band maskBand, final Band dstBand, final int threshold, final int connectedness, final java.util.Vector options, final ProgressCallback callback) {
