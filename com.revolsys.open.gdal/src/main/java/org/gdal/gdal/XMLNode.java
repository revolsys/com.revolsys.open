...
public class XMLNode {
  ...
  public void AddXMLChild(final XMLNode psChild) {
    gdalJNI.XMLNode_AddXMLChild(this.swigCPtr, this, XMLNode.getCPtr(psChild),
      psChild);
  }

  public void AddXMLSibling(final XMLNode psNewSibling) {
    gdalJNI.XMLNode_AddXMLSibling(this.swigCPtr, this,
      XMLNode.getCPtr(psNewSibling), psNewSibling);
  }
  ...
  public XMLNode SearchXMLNode(final String pszElement) {
    final long cPtr = gdalJNI.XMLNode_SearchXMLNode(this.swigCPtr, this,
      pszElement);
    XMLNode ret = null;
    if (cPtr != 0) {
      ret = new XMLNode(cPtr, false);
  ...
  public void StripXMLNamespace(final String pszNamespace, final int bRecurse) {
    gdalJNI.XMLNode_StripXMLNamespace(this.swigCPtr, this, pszNamespace,
      bRecurse);
  }
