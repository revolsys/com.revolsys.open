...
public class AsyncReader {
  ...
  public int GetNextUpdatedRegion(final double timeout, final int[] xoff, final int[] yoff, final int[] buf_xsize, final int[] buf_ysize) {
    return gdalJNI.AsyncReader_GetNextUpdatedRegion(this.swigCPtr, this, timeout, xoff, yoff, buf_xsize, buf_ysize);
  }
