...
public class Band extends MajorObject {
  ...
  public int ComputeStatistics(final boolean approx_ok, final double[] min, final double[] max, final double[] mean) {
    return gdalJNI.Band_ComputeStatistics__SWIG_3(this.swigCPtr, this, approx_ok, min, max, mean);
  }

  public int ComputeStatistics(final boolean approx_ok, final double[] min, final double[] max, final double[] mean, final double[] stddev) {
    return gdalJNI.Band_ComputeStatistics__SWIG_2(this.swigCPtr, this, approx_ok, min, max, mean, stddev);
  }

  public int ComputeStatistics(final boolean approx_ok, final double[] min, final double[] max, final double[] mean, final double[] stddev, final ProgressCallback callback) {
  ...
  public int GetDefaultHistogram(final double[] min_ret, final double[] max_ret, final int[][] buckets_ret) {
    return gdalJNI.Band_GetDefaultHistogram__SWIG_3(this.swigCPtr, this, min_ret, max_ret, buckets_ret);
  }

  public int GetDefaultHistogram(final double[] min_ret, final double[] max_ret, final int[][] buckets_ret, final boolean force) {
    return gdalJNI.Band_GetDefaultHistogram__SWIG_2(this.swigCPtr, this, min_ret, max_ret, buckets_ret, force);
  }

  public int GetDefaultHistogram(final double[] min_ret, final double[] max_ret, final int[][] buckets_ret, final boolean force, final ProgressCallback callback) {
  ...
  public int GetHistogram(final double min, final double max, final int[] buckets, final boolean include_out_of_range, final boolean approx_ok) {
    return gdalJNI.Band_GetHistogram__SWIG_1(this.swigCPtr, this, min, max, buckets, include_out_of_range, approx_ok);
  }

  public int GetHistogram(final double min, final double max, final int[] buckets, final boolean include_out_of_range, final boolean approx_ok, final ProgressCallback callback) {
  ...
  public int GetStatistics(final boolean approx_ok, final boolean force, final double[] min, final double[] max, final double[] mean, final double[] stddev) {
    return GetStatistics(approx_ok ? 1 : 0, force ? 1 : 0, min, max, mean, stddev);
  }

  public int GetStatistics(final int approx_ok, final int force, final double[] min, final double[] max, final double[] mean, final double[] stddev) {
  ...
  public int ReadBlock_Direct(final int nXBlockOff, final int nYBlockOff, final java.nio.ByteBuffer nioBuffer) {
    return gdalJNI.Band_ReadBlock_Direct(this.swigCPtr, this, nXBlockOff, nYBlockOff, nioBuffer);
  }

  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final byte[] array) {
    return ReadRaster(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Byte, array);
  }

  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final double[] array) {
    return ReadRaster(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Float64, array);
  }

  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final float[] array) {
    return ReadRaster(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Float32, array);
  }

  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type, final byte[] array) {
    return ReadRaster(xoff, yoff, xsize, ysize, xsize, ysize, buf_type, array);
  }

  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type, final double[] array) {
    return ReadRaster(xoff, yoff, xsize, ysize, xsize, ysize, buf_type, array);
  }

  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type, final float[] array) {
    return ReadRaster(xoff, yoff, xsize, ysize, xsize, ysize, buf_type, array);
  }

  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final byte[] regularArrayOut) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final byte[] regularArrayOut, final int nPixelSpace) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final byte[] regularArrayOut, final int nPixelSpace, final int nLineSpace) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final double[] regularArrayOut) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final double[] regularArrayOut, final int nPixelSpace) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final double[] regularArrayOut, final int nPixelSpace, final int nLineSpace) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final float[] regularArrayOut) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final float[] regularArrayOut, final int nPixelSpace) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final float[] regularArrayOut, final int nPixelSpace, final int nLineSpace) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final int[] regularArrayOut) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final int[] regularArrayOut, final int nPixelSpace) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final int[] regularArrayOut, final int nPixelSpace, final int nLineSpace) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final short[] regularArrayOut) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final short[] regularArrayOut, final int nPixelSpace) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final short[] regularArrayOut, final int nPixelSpace, final int nLineSpace) {
  ...
  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type, final int[] array) {
    return ReadRaster(xoff, yoff, xsize, ysize, xsize, ysize, buf_type, array);
  }

  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type, final short[] array) {
    return ReadRaster(xoff, yoff, xsize, ysize, xsize, ysize, buf_type, array);
  }

  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int[] array) {
    return ReadRaster(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Int32, array);
  }

  public int ReadRaster(final int xoff, final int yoff, final int xsize, final int ysize, final short[] array) {
    return ReadRaster(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Int16, array);
  }

  public java.nio.ByteBuffer ReadRaster_Direct(final int xoff, final int yoff, final int xsize, final int ysize)
  {
    return ReadRaster_Direct(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Byte);
  }

  public java.nio.ByteBuffer ReadRaster_Direct(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type)
  {
    ...
    final int buf_xsize, final int buf_ysize, final int buf_type)
  {
    ...
    final int ret = ReadRaster_Direct(xoff, yoff, xsize, ysize, buf_xsize, buf_ysize, buf_type, nioBuffer);
  ...
  public int ReadRaster_Direct(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final java.nio.ByteBuffer nioBuffer) {
  ...
  public int ReadRaster_Direct(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final java.nio.ByteBuffer nioBuffer, final int nPixelSpace) {
  ...
  public int ReadRaster_Direct(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final java.nio.ByteBuffer nioBuffer, final int nPixelSpace, final int nLineSpace) {
  ...
  public int SetStatistics(final double min, final double max, final double mean, final double stddev) {
  ...
  public int WriteBlock_Direct(final int nXBlockOff, final int nYBlockOff, final java.nio.ByteBuffer nioBuffer) {
    return gdalJNI.Band_WriteBlock_Direct(this.swigCPtr, this, nXBlockOff, nYBlockOff, nioBuffer);
  }

  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final byte[] array) {
    return WriteRaster(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Byte, array);
  }

  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final double[] array) {
    return WriteRaster(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Float64, array);
  }

  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final float[] array) {
    return WriteRaster(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Float32, array);
  }

  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type, final byte[] array) {
    return WriteRaster(xoff, yoff, xsize, ysize, xsize, ysize, buf_type, array);
  }

  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type, final double[] array) {
    return WriteRaster(xoff, yoff, xsize, ysize, xsize, ysize, buf_type, array);
  }

  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type, final float[] array) {
    return WriteRaster(xoff, yoff, xsize, ysize, xsize, ysize, buf_type, array);
  }

  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final byte[] regularArrayIn) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final byte[] regularArrayIn, final int nPixelSpace) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final byte[] regularArrayIn, final int nPixelSpace, final int nLineSpace) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final double[] regularArrayIn) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final double[] regularArrayIn, final int nPixelSpace) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final double[] regularArrayIn, final int nPixelSpace, final int nLineSpace) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final float[] regularArrayIn) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final float[] regularArrayIn, final int nPixelSpace) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final float[] regularArrayIn, final int nPixelSpace, final int nLineSpace) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final int[] regularArrayIn) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final int[] regularArrayIn, final int nPixelSpace) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final int[] regularArrayIn, final int nPixelSpace, final int nLineSpace) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final short[] regularArrayIn) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final short[] regularArrayIn, final int nPixelSpace) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final short[] regularArrayIn, final int nPixelSpace, final int nLineSpace) {
  ...
  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type, final int[] array) {
    return WriteRaster(xoff, yoff, xsize, ysize, xsize, ysize, buf_type, array);
  }

  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_type, final short[] array) {
    return WriteRaster(xoff, yoff, xsize, ysize, xsize, ysize, buf_type, array);
  }

  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final int[] array) {
    return WriteRaster(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Int32, array);
  }

  public int WriteRaster(final int xoff, final int yoff, final int xsize, final int ysize, final short[] array) {
    return WriteRaster(xoff, yoff, xsize, ysize, xsize, ysize, gdalconstConstants.GDT_Int16, array);
  }

  public int WriteRaster_Direct(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final java.nio.ByteBuffer nioBuffer) {
  ...
  public int WriteRaster_Direct(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final java.nio.ByteBuffer nioBuffer, final int nPixelSpace) {
  ...
  public int WriteRaster_Direct(final int xoff, final int yoff, final int xsize, final int ysize, final int buf_xsize, final int buf_ysize, final int buf_type, final java.nio.ByteBuffer nioBuffer, final int nPixelSpace, final int nLineSpace) {
