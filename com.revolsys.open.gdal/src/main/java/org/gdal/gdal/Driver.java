...
public class Driver extends MajorObject {
  ...
  public Dataset Create(final String utf8_path, final int xsize, final int ysize) {
    final long cPtr = gdalJNI.Driver_Create__SWIG_3(this.swigCPtr, this,
      utf8_path, xsize, ysize);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public Dataset Create(final String utf8_path, final int xsize,
    final int ysize, final int bands) {
    final long cPtr = gdalJNI.Driver_Create__SWIG_2(this.swigCPtr, this,
      utf8_path, xsize, ysize, bands);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public Dataset Create(final String utf8_path, final int xsize,
    final int ysize, final int bands, final int eType) {
    final long cPtr = gdalJNI.Driver_Create__SWIG_1(this.swigCPtr, this,
      utf8_path, xsize, ysize, bands, eType);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }
  ...
  public Dataset Create(final String utf8_path, final int xsize,
    ...
    final long cPtr = gdalJNI.Driver_Create__SWIG_0(this.swigCPtr, this,
      utf8_path, xsize, ysize, bands, eType, options);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public Dataset Create(final String name, final int xsize, final int ysize,
    final int bands, final int eType, final String[] options) {
    return Create(name, xsize, ysize, bands, eType,
      StringArrayToVector(options));
  }

  public Dataset Create(final String name, final int xsize, final int ysize,
    final int bands, final String[] options) {
  ...
  public Dataset CreateCopy(final String utf8_path, final Dataset src) {
    final long cPtr = gdalJNI.Driver_CreateCopy__SWIG_4(this.swigCPtr, this,
      utf8_path, Dataset.getCPtr(src), src);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public Dataset CreateCopy(final String utf8_path, final Dataset src,
    final int strict) {
    final long cPtr = gdalJNI.Driver_CreateCopy__SWIG_3(this.swigCPtr, this,
      utf8_path, Dataset.getCPtr(src), src, strict);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public Dataset CreateCopy(final String utf8_path, final Dataset src,
    final int strict, final java.util.Vector options) {
    final long cPtr = gdalJNI.Driver_CreateCopy__SWIG_2(this.swigCPtr, this,
      utf8_path, Dataset.getCPtr(src), src, strict, options);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }
  ...
  public Dataset CreateCopy(final String utf8_path, final Dataset src,
    ...
    final long cPtr = gdalJNI.Driver_CreateCopy__SWIG_0(this.swigCPtr, this,
      utf8_path, Dataset.getCPtr(src), src, strict, options, callback);
    return cPtr == 0 ? null : new Dataset(cPtr, true);
  }

  public Dataset CreateCopy(final String name, final Dataset src,
    final int strict, final String[] options) {
