...
public class osr implements osrConstants {
  public static CoordinateTransformation CreateCoordinateTransformation(
    ...
    final long cPtr = osrJNI.CreateCoordinateTransformation(
      SpatialReference.getCPtr(src), src, SpatialReference.getCPtr(dst), dst);
  ...
  public static void GetProjectionMethodParamInfo(final String method,
    final String param, final String[] usrname, final String[] type,
    final double[] defaultval) {
    osrJNI.GetProjectionMethodParamInfo(method, param, usrname, type,
      defaultval);
  }
  ...
  public static int GetWellKnownGeogCSAsWKT(final String name,
    final String[] argout) {
