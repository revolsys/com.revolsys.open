...
public class SpatialReference implements Cloneable {
  ...
  public int ExportToUSGS(final int[] code, final int[] zone, final double[] parms, final int[] datum) {
  ...
  public int ImportFromUSGS(final int proj_code, final int zone, final double[] argin, final int datum_code) {
  ...
  public int IsSameVertCS(final SpatialReference rhs) {
    return osrJNI.SpatialReference_IsSameVertCS(this.swigCPtr, this, SpatialReference.getCPtr(rhs), rhs);
  }
  ...
  public int SetACEA(final double stdp1, final double stdp2, final double clat, final double clong, final double fe, final double fn) {
  ...
  public int SetCompoundCS(final String name, final SpatialReference horizcs, final SpatialReference vertcs) {
    return osrJNI.SpatialReference_SetCompoundCS(this.swigCPtr, this, name, SpatialReference.getCPtr(horizcs), horizcs, SpatialReference.getCPtr(vertcs), vertcs);
  }
  ...
  public int SetEC(final double stdp1, final double stdp2, final double clat, final double clong, final double fe, final double fn) {
  ...
  public int SetEquirectangular(final double clat, final double clong, final double fe, final double fn) {
    return osrJNI.SpatialReference_SetEquirectangular(this.swigCPtr, this, clat, clong, fe, fn);
  }

  public int SetEquirectangular2(final double clat, final double clong, final double pseudostdparallellat, final double fe, final double fn) {
  ...
  public int SetGaussSchreiberTMercator(final double clat, final double clong, final double sc, final double fe, final double fn) {
  ...
  public int SetGeogCS(final String pszGeogName, final String pszDatumName, final String pszEllipsoidName, final double dfSemiMajor, final double dfInvFlattening) {
  ...
  public int SetGeogCS(final String pszGeogName, final String pszDatumName, final String pszEllipsoidName, final double dfSemiMajor, final double dfInvFlattening, final String pszPMName) {
  ...
  public int SetGeogCS(final String pszGeogName, final String pszDatumName, final String pszEllipsoidName, final double dfSemiMajor, final double dfInvFlattening, final String pszPMName, final double dfPMOffset) {
  ...
  public int SetGeogCS(final String pszGeogName, final String pszDatumName, final String pszEllipsoidName, final double dfSemiMajor, final double dfInvFlattening, final String pszPMName, final double dfPMOffset, final String pszUnits) {
  ...
  public int SetGeogCS(final String pszGeogName, final String pszDatumName, final String pszEllipsoidName, final double dfSemiMajor, final double dfInvFlattening, final String pszPMName, final double dfPMOffset, final String pszUnits, final double dfConvertToRadians) {
  ...
  public int SetHOM(final double clat, final double clong, final double azimuth, final double recttoskew, final double scale, final double fe, final double fn) {
    return osrJNI.SpatialReference_SetHOM(this.swigCPtr, this, clat, clong, azimuth, recttoskew, scale, fe, fn);
  }

  public int SetHOM2PNO(final double clat, final double dfLat1, final double dfLong1, final double dfLat2, final double dfLong2, final double scale, final double fe, final double fn) {
  ...
  public int SetKrovak(final double clat, final double clong, final double azimuth, final double pseudostdparallellat, final double scale, final double fe, final double fn) {
  ...
  public int SetLCC(final double stdp1, final double stdp2, final double clat, final double clong, final double fe, final double fn) {
    return osrJNI.SpatialReference_SetLCC(this.swigCPtr, this, stdp1, stdp2, clat, clong, fe, fn);
  }

  public int SetLCC1SP(final double clat, final double clong, final double scale, final double fe, final double fn) {
    return osrJNI.SpatialReference_SetLCC1SP(this.swigCPtr, this, clat, clong, scale, fe, fn);
  }

  public int SetLCCB(final double stdp1, final double stdp2, final double clat, final double clong, final double fe, final double fn) {
  ...
  public int SetMercator(final double clat, final double clong, final double scale, final double fe, final double fn) {
  ...
  public int SetOS(final double dfOriginLat, final double dfCMeridian, final double scale, final double fe, final double fn) {
  ...
  public int SetPS(final double clat, final double clong, final double scale, final double fe, final double fn) {
  ...
  public int SetStatePlane(final int zone, final int is_nad83, final String unitsname, final double units) {
    return osrJNI.SpatialReference_SetStatePlane__SWIG_0(this.swigCPtr, this, zone, is_nad83, unitsname, units);
  }

  public int SetStereographic(final double clat, final double clong, final double scale, final double fe, final double fn) {
  ...
  public int SetTargetLinearUnits(final String target, final String name, final double to_meters) {
    return osrJNI.SpatialReference_SetTargetLinearUnits(this.swigCPtr, this, target, name, to_meters);
  }

  public int SetTM(final double clat, final double clong, final double scale, final double fe, final double fn) {
  ...
  public int SetTMSO(final double clat, final double clong, final double scale, final double fe, final double fn) {
    return osrJNI.SpatialReference_SetTMSO(this.swigCPtr, this, clat, clong, scale, fe, fn);
  }

  public int SetTMVariant(final String pszVariantName, final double clat, final double clong, final double scale, final double fe, final double fn) {
  ...
  public int SetTOWGS84(final double p1, final double p2, final double p3, final double p4, final double p5, final double p6, final double p7) {
  ...
  public int SetVertCS(final String VertCSName, final String VertDatumName, final int VertDatumType) {
    return osrJNI.SpatialReference_SetVertCS__SWIG_0(this.swigCPtr, this, VertCSName, VertDatumName, VertDatumType);
  }
