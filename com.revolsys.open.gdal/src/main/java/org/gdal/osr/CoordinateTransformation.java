...
public class CoordinateTransformation {
  /* New in GDAL 1.10 */
  public static CoordinateTransformation CreateCoordinateTransformation(
    final SpatialReference src, final SpatialReference dst) {
  ...
  public CoordinateTransformation(final SpatialReference src,
    final SpatialReference dst) {
    this(osrJNI.new_CoordinateTransformation(SpatialReference.getCPtr(src),
      src, SpatialReference.getCPtr(dst), dst), true);
  }
  ...
  public void TransformPoint(final double[] inout) {
    osrJNI.CoordinateTransformation_TransformPoint__SWIG_0(this.swigCPtr, this,
      inout);
  }

  public void TransformPoint(final double[] argout, final double x,
    final double y) {
    osrJNI.CoordinateTransformation_TransformPoint__SWIG_2(this.swigCPtr, this,
      argout, x, y);
  }

  public void TransformPoint(final double[] argout, final double x,
    final double y, final double z) {
    osrJNI.CoordinateTransformation_TransformPoint__SWIG_1(this.swigCPtr, this,
      argout, x, y, z);
  }
