...
public class SpatiaLiteGeometryAttributeAdder extends JdbcAttributeAdder {

  private static final Logger LOG = LoggerFactory.getLogger(SpatiaLiteGeometryAttributeAdder.class);
  ...
  private final SpatialLiteDataObjectStore dataStore;

  public SpatiaLiteGeometryAttributeAdder(
    final SpatialLiteDataObjectStore dataStore, final DataSource dataSource) {
