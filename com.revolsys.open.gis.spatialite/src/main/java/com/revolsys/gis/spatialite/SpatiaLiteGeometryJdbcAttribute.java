...
public class SpatiaLiteGeometryJdbcAttribute extends JdbcAttribute {
  ...
  // return new SpatiaLiteGeometryJdbcAttribute(getName(), getType(),
  ...
  // (com.vividsolutions.jts.geom.Geometry)object;
  ...
  // geometry =
  // toPgMultiLineString((com.vividsolutions.jts.geom.Geometry)object);
  ...
  // (com.vividsolutions.jts.geom.Point)object;
  // geometry = toPgPoint(point);
  // } else if (object instanceof Coordinates) {
  // final Coordinates coordinates = (Coordinates)object;
  // final com.vividsolutions.jts.geom.Point point =
  // geometryFactory.createPoint(coordinates);
  // geometry = toPgPoint(point);
  // } else if (object instanceof com.vividsolutions.jts.geom.MultiPoint) {
  // final com.vividsolutions.jts.geom.MultiPoint point =
  // (com.vividsolutions.jts.geom.MultiPoint)object;
  ...
  // final com.vividsolutions.jts.geom.MultiLineString lineString =
  // (com.vividsolutions.jts.geom.MultiLineString)object;
  ...
  // final com.vividsolutions.jts.geom.MultiPolygon polygon =
  // (com.vividsolutions.jts.geom.MultiPolygon)object;
  ...
  //
  // @Override
  // public int setInsertPreparedStatementValue(final PreparedStatement
  // statement,
  ...
  // } else {
  // final com.vividsolutions.jts.geom.LineString[] lineStrings = new
  // com.vividsolutions.jts.geom.LineString[lines.length];
  ...
  // final List<com.vividsolutions.jts.geom.Point> points = new
  ...
  // final List<com.vividsolutions.jts.geom.Polygon> polygons = new
  ...
  // final com.vividsolutions.jts.geom.GeometryCollection geometryCollection =
  // (com.vividsolutions.jts.geom.GeometryCollection)object;
  // if (geometryCollection.getNumGeometries() == 1) {
  // final com.vividsolutions.jts.geom.Geometry firstGeometry =
  // geometryCollection.getGeometryN(0);
  // if (firstGeometry instanceof com.vividsolutions.jts.geom.LineString) {
  // final com.vividsolutions.jts.geom.LineString line =
  // (com.vividsolutions.jts.geom.LineString)firstGeometry;
  ...
  // final com.vividsolutions.jts.geom.Geometry subGeometry =
  // geometry.getGeometryN(i);
  // if (subGeometry instanceof com.vividsolutions.jts.geom.LineString) {
  // final com.vividsolutions.jts.geom.LineString line =
  // (com.vividsolutions.jts.geom.LineString)subGeometry;
  ...
  // final MultiLineString pgMultiLineString = new
  // MultiLineString(pgLineStrings);
  ...
  // final com.vividsolutions.jts.geom.Point point =
  // (com.vividsolutions.jts.geom.Point)subGeometry;
  ...
  // final com.vividsolutions.jts.geom.Polygon line =
  // (com.vividsolutions.jts.geom.Polygon)subGeometry;
  ...
  // final com.vividsolutions.jts.geom.Point point =
  // (com.vividsolutions.jts.geom.Point)firstGeometry;
  // return toPgPoint(point);
  // } else {
  // throw new RuntimeException(
  ...
  // }
  //
  // private Polygon toPgPolygon(final com.vividsolutions.jts.geom.Polygon
  // polygon) {
  // final LinearRing[] rings = new LinearRing[1 +
  // polygon.getNumInteriorRing()];
  // final com.vividsolutions.jts.geom.LineString exteriorRing =
  ...
  // final com.vividsolutions.jts.geom.Polygon polygon =
  // (com.vividsolutions.jts.geom.Polygon)firstGeometry;
  // return toPgPolygon(polygon);
  // } else {
  // throw new RuntimeException(
