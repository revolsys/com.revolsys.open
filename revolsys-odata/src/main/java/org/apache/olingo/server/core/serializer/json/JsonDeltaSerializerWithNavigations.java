...
public class JsonDeltaSerializerWithNavigations implements EdmDeltaSerializer {
  ...
  public void writeAddedUpdatedEntity(final ServiceMetadata metadata,
    ...
    final JsonGenerator json, final boolean isFullRepresentation)
  ...
  private void writeDeletedEntity(final Entity deletedEntity, final JsonGenerator json)
    throws IOException, SerializerException {
    ...
    json.writeStartObject();
    json.writeStringField(Constants.ELEM_REASON, ((DeletedEntity)deletedEntity).getReason().name());
  ...
  protected void writeEntitySet(final ServiceMetadata metadata, final EdmEntityType entityType,
    ...
    final boolean onlyReference, final String name, final JsonGenerator json,
  ...
  protected void writeExpandedNavigationProperty(final ServiceMetadata metadata,
    ...
    final boolean writeOnlyRef, final String name, final JsonGenerator json,
    final boolean isFullRepresentation) throws IOException, SerializerException {
  ...
  private void writeLink(final DeltaLink link, final EntityCollectionSerializerOptions options,
    ...
    try {
      ...
      json.writeStringField(Constants.AT + Constants.CONTEXT,
        Constants.HASH + entityId + operation);
      if (link != null) {
