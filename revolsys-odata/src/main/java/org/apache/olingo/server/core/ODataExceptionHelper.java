...
public class ODataExceptionHelper {
  ...
  private static ODataServerError basicServerError(final Exception e) {
    final ODataServerError serverError = new ODataServerError().setException(e)
  ...
  private static ODataServerError basicTranslatedError(final ODataLibraryException e,
    ...
    final ODataServerError serverError = basicServerError(e);
    final ODataErrorMessage translatedMessage = e.getTranslatedMessage(requestedLocale);
  ...
  public static ODataServerError createServerErrorObject(
    final AcceptHeaderContentNegotiatorException e, final Locale requestedLocale) {
    final ODataServerError serverError = basicTranslatedError(e, requestedLocale);
  ...
  public static ODataServerError createServerErrorObject(final DeserializerException e,
    final Locale requestedLocale) {
  ...
  public static ODataServerError createServerErrorObject(final ODataHandlerException e,
    final Locale requestedLocale) {
    final ODataServerError serverError = basicTranslatedError(e, requestedLocale);
    if (ODataHandlerException.MessageKeys.FUNCTIONALITY_NOT_IMPLEMENTED.equals(e.getMessageKey())
    ...
    } else if (ODataHandlerException.MessageKeys.ODATA_VERSION_NOT_SUPPORTED
      .equals(e.getMessageKey())
      ...
      serverError.setStatusCode(HttpStatusCode.BAD_REQUEST.getStatusCode());
    } else if (ODataHandlerException.MessageKeys.HTTP_METHOD_NOT_ALLOWED
      .equals(e.getMessageKey())) {
  ...
  public static ODataServerError createServerErrorObject(final ODataLibraryException e,
    final Locale requestedLocale) {
    final ODataServerError serverError = basicTranslatedError(e, requestedLocale);
  ...
  public static ODataServerError createServerErrorObject(final SerializerException e,
    final Locale requestedLocale) {
    final ODataServerError serverError = basicTranslatedError(e, requestedLocale);
    serverError.setStatusCode(HttpStatusCode.BAD_REQUEST.getStatusCode());
    return serverError;
  ...
  public static ODataServerError createServerErrorObject(final UriParserException e,
    final Locale requestedLocale) {
    final ODataServerError serverError = basicTranslatedError(e, requestedLocale);
    serverError.setStatusCode(HttpStatusCode.BAD_REQUEST.getStatusCode());
    return serverError;
  ...
  public static ODataServerError createServerErrorObject(final UriParserSyntaxException e,
    ...
    final ODataServerError serverError = basicTranslatedError(e, requestedLocale);
    serverError
      .setStatusCode(UriParserSyntaxException.MessageKeys.WRONG_VALUE_FOR_SYSTEM_QUERY_OPTION_FORMAT
        .equals(e.getMessageKey()) ? HttpStatusCode.NOT_ACCEPTABLE.getStatusCode()
