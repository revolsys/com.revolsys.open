...
final class HttpHeaders {
  ...
  public List<String> getHeader(final String name) {
    final List<String> values = this.headers.get(getCanonicalName(name));
  ...
  public Collection<String> getHeaderNames() {
    return this.headers.isEmpty() ? Collections.<String> emptySet()
      : Collections.unmodifiableSet(this.headers.keySet());
  }
  ...
  public Map<String, List<String>> getHeaderToValues() {
    return this.headers.isEmpty() ? Collections.<String, List<String>> emptyMap()
  ...
  public List<String> removeHeader(final String name) {
    return this.headers.remove(getCanonicalName(name));
  }
