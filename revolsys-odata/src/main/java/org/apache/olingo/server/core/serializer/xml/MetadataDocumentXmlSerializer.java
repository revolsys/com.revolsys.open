...
public class MetadataDocumentXmlSerializer {
  ...
  private void appendActionImports(final XMLStreamWriter writer,
    final List<EdmActionImport> actionImports) throws XMLStreamException {
  ...
  private void appendActions(final XMLStreamWriter writer, final List<EdmAction> actions)
  ...
  private void appendAnnotationGroup(final XMLStreamWriter writer,
    final EdmAnnotations annotationGroup) throws XMLStreamException {
  ...
  private void appendAnnotationGroups(final XMLStreamWriter writer,
    final List<EdmAnnotations> annotationGroups) throws XMLStreamException {
    ...
    if (annotations != null && !annotations.isEmpty()) {
      for (final EdmAnnotation annotation : annotations) {
        ...
        if (annotation.getTerm() != null) {
          writer.writeAttribute(XML_TERM_ATT,
  ...
  private void appendComplexTypes(final XMLStreamWriter writer,
    final List<EdmComplexType> complexTypes) throws XMLStreamException {
  ...
  private void appendConstantExpression(final XMLStreamWriter writer,
    final EdmConstantExpression constExp) throws XMLStreamException {
  ...
  private void appendDynamicExpression(final XMLStreamWriter writer,
    final EdmDynamicExpression dynExp) throws XMLStreamException {
  ...
  private void appendEntityContainer(final XMLStreamWriter writer,
  ...
  private void appendEntityTypes(final XMLStreamWriter writer,
    final List<EdmEntityType> entityTypes) throws XMLStreamException {
  ...
  private void appendExpression(final XMLStreamWriter writer, final EdmExpression expression)
    throws XMLStreamException {
    if (expression == null) {
      return;
    }
  ...
  private void appendFunctionImports(final XMLStreamWriter writer,
      ...
      if (returnedEntitySet != null) {
        ...
        if (null != returnedEntitySetNamespace
          ...
          || this.namespaceToAlias.get(returnedEntitySetNamespace) != null
            && this.namespaceToAlias.get(returnedEntitySetNamespace).equals(containerNamespace)) {
          writer.writeAttribute(XML_ENTITY_SET, returnedEntitySet.getName());
        } else {
          writer.writeAttribute(XML_ENTITY_SET,
  ...
  private void appendLogicalOrComparisonExpression(final XMLStreamWriter writer,
    final EdmLogicalOrComparisonExpression exp) throws XMLStreamException {
    appendExpression(writer, exp.getLeftExpression());
    appendExpression(writer, exp.getRightExpression());
    appendAnnotations(writer, exp);
  }

  private void appendNavigationProperties(final XMLStreamWriter writer,
    final EdmStructuredType type) throws XMLStreamException {
  ...
  private void appendNavigationPropertyBindings(final XMLStreamWriter writer,
    final EdmBindingTarget bindingTarget) throws XMLStreamException {
  ...
  private void appendNotExpression(final XMLStreamWriter writer, final EdmNot exp)
    throws XMLStreamException {
    appendExpression(writer, exp.getLeftExpression());
    appendAnnotations(writer, exp);
  }
  ...
  private void appendTerms(final XMLStreamWriter writer, final List<EdmTerm> terms)
    throws XMLStreamException {
    for (final EdmTerm term : terms) {
      ...
      if (term.getBaseTerm() != null) {
        writer.writeAttribute(XML_BASE_TERM,
          getAliasedFullQualifiedName(term.getBaseTerm().getFullQualifiedName(), false));
      }
  ...
  private void appendTypeDefinitions(final XMLStreamWriter writer,
    final List<EdmTypeDefinition> typeDefinitions) throws XMLStreamException {
