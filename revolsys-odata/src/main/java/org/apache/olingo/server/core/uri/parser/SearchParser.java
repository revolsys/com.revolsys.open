...
public class SearchParser {
  ...
  public SearchOption parse(final UriTokenizer tokenizer) throws SearchParserException {
    final SearchOptionImpl searchOption = new SearchOptionImpl();
    searchOption.setSearchExpression(processExprOr(tokenizer));
    return searchOption;
  }

  private SearchExpression processExprAnd(final UriTokenizer tokenizer)
  ...
  private SearchExpression processExprOr(final UriTokenizer tokenizer)
    throws SearchParserException {
  ...
  private SearchExpression processNot(final UriTokenizer tokenizer) throws SearchParserException {
