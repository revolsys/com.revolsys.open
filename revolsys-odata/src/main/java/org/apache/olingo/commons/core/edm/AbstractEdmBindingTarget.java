...
public abstract class AbstractEdmBindingTarget extends AbstractEdmNamed
  ...
  public EdmEntityType getEntityType() {
    final EdmEntityType entityType = this.edm.getEntityType(this.target.getTypeFQN());
    if (entityType == null) {
  ...
  public List<EdmNavigationPropertyBinding> getNavigationPropertyBindings() {
    if (this.navigationPropertyBindings == null) {
      ...
      final List<EdmNavigationPropertyBinding> navigationPropertyBindingsLocal = new ArrayList<>();
      if (providerBindings != null) {
        for (final CsdlNavigationPropertyBinding binding : providerBindings) {
          navigationPropertyBindingsLocal
            .add(new EdmNavigationPropertyBindingImpl(binding.getPath(), binding.getTarget()));
        }
  ...
  public EdmBindingTarget getRelatedBindingTarget(final String path) {
    ...
    boolean found = false;
    for (final Iterator<EdmNavigationPropertyBinding> itor = getNavigationPropertyBindings()
      ...
      if (path.equals(binding.getPath())) {
        final Target edmTarget = new Target(binding.getTarget(), this.container);
