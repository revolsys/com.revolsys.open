...
public interface CsdlEdmProvider {
   ...
   */
  CsdlActionImport getActionImport(final FullQualifiedName entityContainer,
   ...
   * @throws ODataException
   */
  CsdlAnnotations getAnnotationsGroup(FullQualifiedName targetName, String qualifier)
    throws ODataException;
   ...
   * @throws ODataException
   */
  CsdlFunctionImport getFunctionImport(final FullQualifiedName entityContainer,
   ...
   * @throws ODataException
   */
  CsdlTypeDefinition getTypeDefinition(final FullQualifiedName typeDefinitionName)
    throws ODataException;
}
