...
public class ODataNettyImpl extends ODataNetty {
  ...
  @Override
  public ODataDeserializer createDeserializer(final ContentType contentType,
    final ServiceMetadata metadata) throws DeserializerException {
    return odata.createDeserializer(contentType);
  }

  @Override
  public ODataDeserializer createDeserializer(final ContentType contentType,
    final ServiceMetadata metadata, final List<String> versions) throws DeserializerException {
  ...
  @Override
  public EdmDeltaSerializer createEdmDeltaSerializer(final ContentType contentType,
    final List<String> versions) throws SerializerException {
  ...
  @Override
  public ODataNettyHandler createNettyHandler(final ServiceMetadata serviceMetadata) {
  ...
  @Override
  public ODataHandler createRawHandler(final ServiceMetadata serviceMetadata) {
