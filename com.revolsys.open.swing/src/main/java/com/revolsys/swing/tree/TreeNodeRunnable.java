...
public class TreeNodeRunnable extends InvokeMethodRunnable {
  ...
  public static InvokeMethodAction createAction(final CharSequence name, final Icon icon,
    ...
    final TreeNodeRunnable runnable = new TreeNodeRunnable(methodName, parameters);
    final InvokeMethodAction action = new InvokeMethodAction(name, name.toString(), icon, true,
      runnable);
