...
public enum CartoCssProperty {
 image_filters("image-filters"),
  ...
  shield_text_dx("shield-text-dx"),
  shield_text_dy("shield-text-dy"),
  shield_dx("shield-dx"),
  shield_dy("shield-dy"),
  ...
  raster_mesh_size("raster-mesh-size"),
  ...
  text_wrap_width("text-wrap-width"),
  ...
  private String name;
  private CartoCssProperty(String name) {
    this.name = name;
  }
  ...
  public static CartoCssProperty getProperty(String name) {
