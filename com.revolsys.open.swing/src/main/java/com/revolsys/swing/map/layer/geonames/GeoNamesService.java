...
public class GeoNamesService {
  ...
  public List<Record> getNames(final BoundingBox boundingBox) {
    ...
    final double radius = geometryFactory.getEllipsoid().getSemiMajorAxis();
  ...
  public List<Record> getWikipediaArticles(final BoundingBox boundingBox) {
    final BoundingBox geographicBoundingBox = boundingBox
      .bboxToCs(GeometryFactory.floating3d(EpsgId.WGS84));
    final Map<String, Object> params = new HashMap<>();
