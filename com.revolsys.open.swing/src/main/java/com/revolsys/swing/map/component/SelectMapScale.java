...
public class SelectMapScale extends JComboBox implements ItemListener,
  ...
  private static final Object[] SCALES = {
    ...
    125000.0, 50000.0,  20000.0, 10000.0, 5000.0, 2500.0, 2000.0,
    1000.0
  };

  private Viewport2D viewport;

  public SelectMapScale(Viewport2D viewport) {
    super(SCALES);
    this.viewport = viewport;
    setEditable(true);
    InvokeMethodStringConverter renderer = new InvokeMethodStringConverter(
  ...
  public void setScales(List<Double> resolutionList) {
