...
public class PasswordField extends JPasswordField implements Field, FocusListener {
  ...
  public PasswordField(final String fieldName) {
    this(fieldName, "");
  }

  public PasswordField(final String fieldName, final int columns) {
    this(fieldName);
    setColumns(columns);
  }

  public PasswordField(String fieldName, final Object fieldValue) {
