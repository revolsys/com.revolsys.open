...
public class Bcgs1250RectangularMapGridTest extends Bcgs2500RectangularMapGridTest {
  ...
  protected void doTestBcgs1250ByName(final String parentTileName, final double parentLon,
    final double parentLat) {
    checkTileByName(GRID, parentTileName, parentLon, parentLat, TILE_WIDTH, TILE_HEIGHT);
  }

  @Override
  protected void doTestBcgs2500ByName(final String parentTileName, final double parentLon,
    final double parentLat) {
