package com.revolsys.core.test.geometry.test.old.perf.geom.prep;

import com.revolsys.core.test.geometry.test.old.perf.ThreadTestCase;
import com.revolsys.core.test.geometry.test.old.perf.ThreadTestRunner;
...
public class PreparedGeometryThreadSafeTest extends ThreadTestCase {
  ...
  GeometryFactory factory = GeometryFactory.fixed2d(0, 1.0, 1.0);
