...
public class MultiGenerator extends GeometryGenerator {
  ...
  /**
   * @see com.revolsys.core.test.geometry.testold.generator.GeometryGenerator#setDimensions(int)
   */
  @Override
  ...
  /**
   * @see com.revolsys.core.test.geometry.testold.generator.GeometryGenerator#setGeometryFactory(com.revolsys.core.test.geometry.model.GeometryFactory)
   */
  @Override
