...
import com.revolsys.core.test.geometry.test.model.CoordinatesTest;
...
public class NormalizeTest extends TestCase {
  ...
  public void testNormalizeMultiPolygon() throws Exception {
    ...
    final Polygonal expectedValue = (Polygonal)this.geometryFactory.geometry(
      "MULTIPOLYGON(((40 280,140 280,140 360,40 360,40 280),(60 300,60 340,120 340,120 300,60 300)),((140 100,260 100,260 200,140 200,140 100),(160 120,160 180,240 180,240 120,160 120)))");
    assertEqualsExact(expectedValue, actualValue);
  }
  ...
  public void testNormalizePolygon1() throws Exception {
    ...
    final Polygon expectedValue = (Polygon)this.geometryFactory.geometry(
      "POLYGON((20 200,120 80,240 200,120 320,20 200),(60 200,80 220,80 200,60 200),(120 140,140 160,140 140,120 140),(120 260,140 240,140 220,120 260),(160 200,180 220,180 200,160 200))");
    assertEqualsExact(expectedValue, actualValue);
  }
}
