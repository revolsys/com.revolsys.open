...
public abstract class AbstractUrlMethodNameResolver {
   ...
   */
  public final String getHandlerMethodName(final HttpServletRequest request) {

    final String urlPath = this.urlPathHelper.getLookupPathForRequest(request);
    final String name = getHandlerMethodNameForUrlPath(urlPath);
    if (name == null) {
      throw new RuntimeException(urlPath);
    }
