...
public class ViewObject extends SpringFrameworkAction {
  private static final Logger log = Logger.getLogger(ViewObject.class);
  ...
  public void process(final HttpServletRequest request,
    ...
    if (object != null) {
      request.setAttribute("view", builder.createDetailView(object, "objectView", "view",
        request.getLocale()));
    }
  }
}
