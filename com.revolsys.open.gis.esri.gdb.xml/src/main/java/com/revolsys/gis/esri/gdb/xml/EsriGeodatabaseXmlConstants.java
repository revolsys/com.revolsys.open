...
public interface EsriGeodatabaseXmlConstants {
  ...
  QName AREA_FIELD_NAME = new QName(_NAMESPACE_URI, "AreaFieldName",
    _NAMESPACE_PREFIX);

  QName ARRAY_OF_CONTROLLER_MEMBERSHIP = new QName(_NAMESPACE_URI,
    "ArrayOfControllerMembership", _NAMESPACE_PREFIX);

  QName ARRAY_OF_CODED_VALUE = new QName(_NAMESPACE_URI, "ArrayOfCodedValue",
    _NAMESPACE_PREFIX);

  QName CODE = new QName(_NAMESPACE_URI, "Code", _NAMESPACE_PREFIX);

  QName ARRAY_OF_DATA_ELEMENT = new QName(_NAMESPACE_URI, "ArrayOfDataElement",
    _NAMESPACE_PREFIX);

  QName ARRAY_OF_DOMAIN = new QName(_NAMESPACE_URI, "ArrayOfDomain",
    _NAMESPACE_PREFIX);

  QName ARRAY_OF_FIELD = new QName(_NAMESPACE_URI, "ArrayOfField",
    _NAMESPACE_PREFIX);

  QName ARRAY_OF_INDEX = new QName(_NAMESPACE_URI, "ArrayOfIndex",
    _NAMESPACE_PREFIX);

  QName ARRAY_OF_PROPERTY_SET_PROPERTY = new QName(_NAMESPACE_URI,
    "ArrayOfPropertySetProperty", _NAMESPACE_PREFIX);

  QName AVG_NUM_POINTS = new QName(_NAMESPACE_URI, "AvgNumPoints",
    _NAMESPACE_PREFIX);

  QName CAN_VERSION = new QName(_NAMESPACE_URI, "CanVersion", _NAMESPACE_PREFIX);

  QName CATALOG_PATH = new QName(_NAMESPACE_URI, "CatalogPath",
    _NAMESPACE_PREFIX);
  ...
  QName CODED_VALUE_DOMAIN = new QName(_NAMESPACE_URI, "CodedValueDomain",
    _NAMESPACE_PREFIX);

  QName CODED_VALUES = new QName(_NAMESPACE_URI, "CodedValues",
    _NAMESPACE_PREFIX);

  QName CONFIGURATION_KEYWORD = new QName(_NAMESPACE_URI,
    "ConfigurationKeyword", _NAMESPACE_PREFIX);

  QName CONTROLLER_MEMBERSHIP = new QName(_NAMESPACE_URI,
    "ControllerMembership", _NAMESPACE_PREFIX);

  QName CONTROLLER_MEMBERSHIPS = new QName(_NAMESPACE_URI,
    "ControllerMemberships", _NAMESPACE_PREFIX);
  ...
  QName DATA_ELEMENT = new QName(_NAMESPACE_URI, "DataElement",
    _NAMESPACE_PREFIX);
  ...
  QName DATASET_DATA = new QName(_NAMESPACE_URI, "DatasetData",
    _NAMESPACE_PREFIX);
  ...
  QName DATASET_NAME = new QName(_NAMESPACE_URI, "DatasetName",
    _NAMESPACE_PREFIX);

  QName DATASET_TYPE = new QName(_NAMESPACE_URI, "DatasetType",
    _NAMESPACE_PREFIX);
  ...
  QName DE_FEATURE_CLASS = new QName(_NAMESPACE_URI, "DEFeatureClass",
    _NAMESPACE_PREFIX);

  QName DE_FEATURE_DATASET = new QName(_NAMESPACE_URI, "DEFeatureDataset",
    _NAMESPACE_PREFIX);

  QName DE_GEO_DATASET = new QName(_NAMESPACE_URI, "DEGeoDataset",
    _NAMESPACE_PREFIX);
  ...
  QName DEFAULT_VALUE = new QName(_NAMESPACE_URI, "DefaultValue",
    _NAMESPACE_PREFIX);
  ...
  QName DOMAIN_FIXED = new QName(_NAMESPACE_URI, "DomainFixed",
    _NAMESPACE_PREFIX);
  ...
  QName FEATURE_TYPE = new QName(_NAMESPACE_URI, "FeatureType",
    _NAMESPACE_PREFIX);
  ...
  QName MERGE_POLICY = new QName(_NAMESPACE_URI, "MergePolicy",
    _NAMESPACE_PREFIX);

  QName SPLIT_POLICY = new QName(_NAMESPACE_URI, "SplitPolicy",
    _NAMESPACE_PREFIX);

  QName DESCRIPTION = new QName(_NAMESPACE_URI, "Description",
    _NAMESPACE_PREFIX);
  ...
  QName GEOGRAPHIC_COORDINATE_SYSTEM = new QName(_NAMESPACE_URI,
    "GeographicCoordinateSystem", _NAMESPACE_PREFIX);

  String GEOGRAPHIC_COORDINATE_SYSTEM_TYPE = "esri:GeographicCoordinateSystem";

  QName GEOMETRY_DEF = new QName(_NAMESPACE_URI, "GeometryDef",
    _NAMESPACE_PREFIX);

  String GEOMETRY_DEF_TYPE = "esri:GeometryDef";

  QName GEOMETRY_TYPE = new QName(_NAMESPACE_URI, "GeometryType",
    _NAMESPACE_PREFIX);
  ...
  QName HAS_GLOBAL_ID = new QName(_NAMESPACE_URI, "HasGlobalID",
    _NAMESPACE_PREFIX);
  ...
  QName HAS_SPATIAL_INDEX = new QName(_NAMESPACE_URI, "HasSpatialIndex",
    _NAMESPACE_PREFIX);

  QName HAS_Z = new QName(_NAMESPACE_URI, "HasZ", _NAMESPACE_PREFIX);

  QName HIGH_PRECISION = new QName(_NAMESPACE_URI, "HighPrecision",
    _NAMESPACE_PREFIX);
  ...
  QName IS_ASCENDING = new QName(_NAMESPACE_URI, "IsAscending",
    _NAMESPACE_PREFIX);
  ...
  QName LENGTH_FIELD_NAME = new QName(_NAMESPACE_URI, "LengthFieldName",
    _NAMESPACE_PREFIX);
  ...
  QName OBJECT_ID_FIELD_NAME = new QName(_NAMESPACE_URI, "OIDFieldName",
    _NAMESPACE_PREFIX);
  ...
  QName PROJECTED_COORDINATE_SYSTEM = new QName(_NAMESPACE_URI,
    "ProjectedCoordinateSystem", _NAMESPACE_PREFIX);

  String PROJECTED_COORDINATE_SYSTEM_TYPE = "esri:ProjectedCoordinateSystem";

  QName PROPERTY_ARRAY = new QName(_NAMESPACE_URI, "PropertyArray",
    _NAMESPACE_PREFIX);

  String PROPERTY_ARRAY_TYPE = "esri:ArrayOfPropertySetProperty";

  QName PROPERTY_SET = new QName(_NAMESPACE_URI, "PropertySet",
    _NAMESPACE_PREFIX);

  QName PROPERTY_SET_PROPERTY = new QName(_NAMESPACE_URI,
    "PropertySetProperty", _NAMESPACE_PREFIX);

  String PROPERTY_SET_TYPE = "esri:PropertySet";

  QName RASTER_FIELD_NAME = new QName(_NAMESPACE_URI, "RasterFieldName",
    _NAMESPACE_PREFIX);
  ...
  QName RELATIONSHIP_CLASS_NAMES = new QName(_NAMESPACE_URI,
    "RelationshipClassNames", _NAMESPACE_PREFIX);
  ...
  QName SHAPE_FIELD_NAME = new QName(_NAMESPACE_URI, "ShapeFieldName",
    _NAMESPACE_PREFIX);
  ...
  QName SUBTYPE_CODE = new QName(_NAMESPACE_URI, "SubtypeCode",
    _NAMESPACE_PREFIX);
  ...
  QName WORKSPACE_DATA = new QName(_NAMESPACE_URI, "WorkspaceData",
    _NAMESPACE_PREFIX);
  ...
  QName WORKSPACE_TYPE = new QName(_NAMESPACE_URI, "WorkspaceType",
    _NAMESPACE_PREFIX);
  ...
  QName XML_PROPERTY_SET = new QName(_NAMESPACE_URI, "XmlPropertySet",
    _NAMESPACE_PREFIX);
  ...
  QName XY_TOLERANCE = new QName(_NAMESPACE_URI, "XYTolerance",
    _NAMESPACE_PREFIX);
