...
public class LayerTreeModel extends SimpleTreeModel {
  ...
  public LayerTreeModel(final LayerManagerProxy layerManagerProxy) {
    super(new Root());
  ...
  public static class ColorThemingValue {
    ...
    public ColorThemingValue(final Object value, final BasicStyle style,
      final String label) {
      this.value = value;
      this.style = style;
    ...
    public boolean equals(final Object other) {
      return other instanceof ColorThemingValue
        && LangUtil.bothNullOrEqual(value, ((ColorThemingValue)other).value)
  ...
  public List getChildren(final Object parent) {
    ...
    if (parent instanceof ThemedLayerable) {
      ThemedLayerable themedLayer = (ThemedLayerable)parent;
      return themedLayer.getThemes();
    ...
    if (parent instanceof Layer
      ...
      Map attributeValueToBasicStyleMap = ColorThemingStyle.get((Layer)parent)
        .getAttributeValueToBasicStyleMap();
      Map attributeValueToLabelMap = ColorThemingStyle.get((Layer)parent)
