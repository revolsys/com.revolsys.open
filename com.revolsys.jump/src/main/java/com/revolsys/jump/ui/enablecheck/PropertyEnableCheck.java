package com.revolsys.jump.ui.enablecheck;
...
public class PropertyEnableCheck implements EnableCheck {
  ...
  public PropertyEnableCheck(final Object object, final String checkMethodName,
    final Object expectedValue, final boolean invert,
   ...
   */
  public PropertyEnableCheck(final Object object, final String checkMethodName,
    final Object expectedValue, final ErrorHandler errorHandler) {
  ...
  private String getResult(final boolean equal) {
    if (equal || invert) {
      return null;
    } else {
